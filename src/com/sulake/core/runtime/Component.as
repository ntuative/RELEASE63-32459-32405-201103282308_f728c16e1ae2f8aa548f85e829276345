package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      protected static const const_422:String = "_INTERNAL_EVENT_UNLOCKED";
      
      public static const COMPONENT_FLAG_NULL:uint = 0;
      
      public static const const_1921:uint = 1;
      
      public static const COMPONENT_FLAG_CONTEXT:uint = 2;
      
      public static const const_1137:uint = 4;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            this.var_1300 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1300);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1406 & const_1137)
         {
            if(_loc3_ == 0)
            {
      ...
      protected final function unlock() : void
      {
         ...
         {
            this.var_967 = false;
            this._events.dispatchEvent(new LockEvent(const_422,this));
         }
      }
