package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1332:String = "asset-libraries";
      
      private static const const_1336:String = "library";
      
      private static const const_1337:String = "service-libraries";
      
      private static const const_1333:String = "library";
      
      private static const const_1339:String = "component-libraries";
      
      private static const const_1340:String = "library";
      
      private static const const_1335:String = "error_data";
      
      private static const const_1334:String = "error_cat";
      
      private static const const_1338:String = "error_desc";
       
      
      private var var_359:LibraryLoaderQueue;
      
      private var var_755:IEventDispatcher;
      
      private var var_498:uint;
      
      private var var_358:Function;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         switch(param2 & 0)
         {
            case Core.const_1070:
               ...
               this.var_358 = this.simpleFrameUpdateHandler;
               break;
            case Core.const_820:
               debug("Core; using complex frame update handler");
               this.var_358 = this.complexFrameUpdateHandler;
               break;
            case Core.const_659:
               debug("Core; using profiler frame update handler");
               this.var_358 = this.profilerFrameUpdateHandler;
               this.var_203 = new Profiler(this);
               attachComponent(this.var_203,[new IIDProfiler()]);
               var_399.addChild(new ProfilerViewer(this.var_203));
               break;
            case Core.const_475:
               debug("Core; using experimental frame update handler");
               this.var_358 = this.experimentalFrameUpdateHandler;
               break;
            case Core.CORE_SETUP_DEBUG:
               debug("Core; using debug frame update handler");
               this.var_358 = this.debugFrameUpdateHandler;
         }
      }
      ...
      {
         return this.var_498 - this.getNumberOfFilesPending();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            try
            {
               ...
               {
                  receivers = this.var_254[i] as Array;
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1335,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1334,String(param3));
         ErrorReportStorage.setParameter(const_1338,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_755 = loadingEventDelegate;
         if(this.var_359 == null)
         {
            this.var_359 = new LibraryLoaderQueue(_debug);
         }
         try
         {
            node = config.child(const_1332)[0];
            if(node != null)
            {
         ...
         try
         {
            node = config.child(const_1337)[0];
            if(node != null)
            {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_755)
         {
            this.var_755.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_755)
         {
            ...
            this.var_755.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_755)
                  {
                     this.var_755.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_498 - this.var_359.length,this.var_498,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_203 ? 0 : this.var_1406 & 0;
         if(_loc3_ == Core.const_475)
         {
            this.var_254[param2].push(new UpdateDelegate(param1,this,param2));
         }
         else
         {
            this.var_254[param2].push(param1);
         }
      }
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:* = null;
         var _loc4_:int = !!this.var_203 ? 0 : this.var_1406 & 0;
         var _loc5_:int = 0;
         while(_loc5_ < CoreComponentContext.const_102)
         {
            _loc3_ = this.var_254[_loc5_] as Array;
            if(_loc4_ == Core.const_475)
            {
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         this.var_358(_loc2_,_loc2_ - this._lastUpdateTimeMs);
      ...
      private function simpleFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(priority < CoreComponentContext.const_102)
         {
            ...
            receivers = this.var_254[priority];
            index = 0;
            length = receivers.length;
            while(index != length)
            {
