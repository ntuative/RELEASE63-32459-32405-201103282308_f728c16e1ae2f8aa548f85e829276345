package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1042:String = "AssetLibraryReady";
      
      public static const const_864:String = "AssetLibraryLoaded";
      
      public static const const_1478:String = "AssetLibraryUnloaded";
      
      public static const const_1724:String = "AssetLibraryLoadError";
      ...
      private static var var_1941:LazyAssetProcessor = new LazyAssetProcessor();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         this.var_996 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_658 + " doesn\'t contain valid resource class!");
         }
         ...
         if(_loc5_ != null)
         {
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_658 + "!");
               }
               _loc15_++;
            }
         }
      ...
      {
         if(this.var_658 == param1.url && this.var_994)
         {
            if(!this.var_997 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_657);
            }
            this.var_997 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1042));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         this.var_994 = false;
         this.var_658 = null;
         dispatchEvent(new Event(AssetLibrary.const_1478));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_996[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1222,this.assetLoadEventHandler);
      ...
      {
         return this.var_169[param1] != null || (this.var_657 != null ? this.var_657[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_1941.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_657 = _loc2_.resource;
         this.var_658 = _loc2_.url;
         if(this.var_997)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_657);
         }
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1724));
         this.var_42 = null;
      }
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc8_ < _loc7_)
            {
               ...
               if(_loc3_.attribute(const_427).toString() == param1)
               {
                  ...
                  if(_loc4_ == null)
                  {
                     throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_658 + "!");
                  }
                  _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                  _loc5_.setUnknownContent(this.var_657[param1]);
