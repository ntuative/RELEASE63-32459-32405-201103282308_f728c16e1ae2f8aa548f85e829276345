package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_1049:LoaderContext;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         this.var_1049 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         this.var_466 = new AssetLibrary("lib-" + this.var_562++);
         this.var_29.push(this.var_466);
      }
      ...
      public function loadFromFile(param1:LibraryLoader, param2:Boolean = false) : void
      {
         ...
         {
            this.loaderContext = this.var_1049;
         }
         var _loc3_:IAssetLibrary = new AssetLibrary("lib-" + this.var_562++);
         this.var_560.push(_loc3_);
      ...
      public function unload() : void
      {
         ...
         {
            (this.var_560.pop() as IAssetLibrary).dispose();
         }
      ...
      private function loadEventHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE)
         {
            ...
            _loc4_ = 0;
            while(_loc4_ < this.var_560.length)
            {
               _loc3_ = this.var_560[_loc4_] as IAssetLibrary;
