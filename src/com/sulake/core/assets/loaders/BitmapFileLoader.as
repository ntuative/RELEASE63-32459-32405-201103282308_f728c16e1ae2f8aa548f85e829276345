package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         this.var_1048 = param2 == null ? "" : param2.url;
         this._type = param1;
         this.var_42 = new Loader();
         this.var_1049 = new LoaderContext();
         this.var_1049.checkPolicyFile = true;
         ...
         {
            this.var_42.load(param2,this.var_1049);
         }
      }
      ...
      {
         this.var_1048 = param1.url;
         var_331 = 0;
         this.var_42.load(param1,this.var_1049);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_331 < var_2859)
            {
               ...
               this.var_42.load(new URLRequest(this.var_1048 + (this.var_1048.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_331),this.var_1049);
               return true;
            }
         }
         return false;
