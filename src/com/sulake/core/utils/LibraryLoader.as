package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1752:uint = 1;
      
      protected static const const_1753:uint = 2;
      
      protected static const const_1751:uint = 4;
      ...
      private static var var_733:Array = new Array();
      ...
      protected var var_2847:String = "";
      
      protected var var_2077:int;
      
      protected var var_1301:int;
      
      protected var var_1302:int;
      
      protected var var_2935:uint = 0;
      
      protected var var_2848:Boolean = true;
      ...
      protected static function queue(param1:LibraryLoader) : void
      {
         ...
         {
            param1.var_42.load(param1.var_237,param1._context);
         }
      }
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1232)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_733[_loc2_] as LibraryLoader;
            ...
            while(var_733.length < const_1664 && false)
            {
               _loc1_ = var_908.shift() as LibraryLoader;
               if(!_loc1_.ready && !_loc1_.disposed)
               {
                  var_733.push(_loc1_);
                  _loc1_.var_42.load(_loc1_.var_237,_loc1_._context);
               }
            }
         }
      }
      ...
      {
         return !!this.var_1047 ? uint(this.var_1301 - this.var_2077) : uint(getTimer() - this.var_2077);
      }
      ...
      {
         if(!this.var_1047 && !_disposed && this.var_1302 > 0)
         {
            try
            {
               this.var_42.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_237,const_1487 - this.var_1302);
            if(this.var_2848)
            {
            ...
            --this.var_1302;
            this.var_463 = 0;
            this.var_42.load(this.var_237,this._context);
            return true;
         }
         return false;
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_463 = LibraryLoader.name_3;
         ...
         if(this.var_463 == LibraryLoader.const_1754)
         {
         ...
         if(this.var_463 == LibraryLoader.name_3)
         {
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_657 = this.getDefinition(this._name) as Class;
         ...
         try
         {
            xmlClass = this.var_657.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
