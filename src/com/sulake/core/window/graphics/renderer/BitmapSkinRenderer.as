package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_850:Dictionary;
      
      private var var_915:Matrix;
      
      public function BitmapSkinRenderer(param1:String)
      {
         super(param1);
         this.var_849 = new Dictionary(false);
         this.var_850 = new Dictionary(false);
         this.var_915 = new Matrix();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            this.var_849 = null;
            for(_loc1_ in this.var_850)
            {
               _loc2_ = this.var_850[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_850[_loc1_];
            }
            this.var_850 = null;
         }
      }
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         var _loc7_:ISkinLayout = var_462[param4];
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc16_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc10_.scaleH == SkinLayoutEntity.const_328)
                  {
                     var_34.x += _loc14_;
                  }
                  ...
                  if(_loc10_.scaleV == SkinLayoutEntity.const_328)
                  {
                     var_34.y += _loc15_;
                  }
                  ...
                  {
                     this.var_915.a = 0 / _loc17_.width;
                     this.var_915.d = 0 / _loc17_.height;
                     _loc30_ = new BitmapData(var_34.width,var_34.height,false);
                     _loc30_.draw(_loc17_,this.var_915);
                     _loc31_ = new BitmapData(var_34.width,var_34.height,true,0);
                     _loc31_.draw(_loc18_,this.var_915,null);
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:ISkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.scaleH == SkinLayoutEntity.const_328)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.scaleV == SkinLayoutEntity.const_328)
               {
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = this.var_850[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)
