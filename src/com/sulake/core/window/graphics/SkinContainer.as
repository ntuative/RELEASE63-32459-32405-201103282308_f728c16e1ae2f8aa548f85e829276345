package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1021:uint = 8;
      
      private static const const_1437:String = "skin";
      
      private static const const_1435:String = "bitmap";
      
      private static const const_1438:String = "fill";
      
      private static const const_1439:String = "text";
      
      private static const const_1436:String = "label";
      
      private static const const_1440:String = "shape";
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         TypeCodeTable.fillTables(this.var_2009,this.var_2802);
         this.var_2803 = new Dictionary();
         this.var_2804 = new Dictionary();
         StateCodeTable.fillTables(this.var_2803,this.var_2804);
         this.var_458 = new Dictionary();
         this.var_458[const_1437] = BitmapSkinRenderer;
         this.var_458[const_1435] = BitmapDataRenderer;
         this.var_458[const_1438] = FillSkinRenderer;
         this.var_458[const_1439] = TextSkinRenderer;
         this.var_458[const_1436] = LabelRenderer;
         this.var_458[const_1440] = ShapeSkinRenderer;
         this.var_458[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_458[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_334 == null)
         {
            var_334 = new Array();
            var_334.push(WindowState.const_67);
            var_334.push(WindowState.const_85);
            var_334.push(WindowState.const_98);
            var_334.push(WindowState.const_56);
            var_334.push(WindowState.const_95);
            var_334.push(WindowState.const_86);
         ...
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2842 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_2009[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_1025[param1] = new Array(const_1021);
         }
         this.var_1025[param1][param2] = param3;
         if(this.var_1026[param1] == null)
         {
            this.var_1026[param1] = new Array(const_1021);
         }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1025[param1];
         if(_loc3_)
         {
