package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1485:uint = 0;
      
      public static const const_896:uint = 1;
      
      public static const const_1121:uint = 2;
      
      public static const const_810:uint = 4;
      
      public static const const_1552:uint = 8;
      
      public static const const_1698:uint = 16;
      
      public static const const_2007:uint = 64;
      
      public static const const_1828:uint = 128;
      
      public static const const_1132:uint = 256;
      
      protected static var var_562:uint = 0;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            case GraphicContext.const_896:
               ...
               break;
            case GraphicContext.const_1121:
         ...
         if(this.var_853)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2090,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2090,16777215);
                  }
                  var_333 += bitmap.width * bitmap.height * 4;
               }
