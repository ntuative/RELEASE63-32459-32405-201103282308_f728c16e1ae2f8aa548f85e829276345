package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_2030:String = "_INCLUDE";
      
      public static const const_1848:String = "_TEMP";
      
      private static const const_1417:String = "layout";
      
      private static const const_1009:String = "window";
      
      private static const const_1008:String = "variables";
      
      private static const const_1010:String = "filters";
      
      private static const const_427:String = "name";
      
      private static const const_1413:String = "style";
      
      private static const const_631:String = "params";
      
      private static const const_1407:String = "tags";
      
      private static const X:String = "x";
      
      private static const Y:String = "y";
      
      private static const const_1356:String = "width";
      
      private static const const_1357:String = "height";
      
      private static const const_1406:String = "visible";
      
      private static const const_1409:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_5:String = "background";
      
      private static const const_1213:String = "blend";
      ...
      private static const const_1415:String = "children";
      
      private static const const_1418:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1410:String = "height_min";
      
      private static const const_1414:String = "height_max";
      
      private static const const_630:String = "true";
      
      private static const const_175:String = "0";
      
      private static const const_1411:String = "$";
      
      private static const const_1355:String = ",";
      
      private static const const_50:String = "";
      
      private static const const_1408:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1416:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_1053:Dictionary;
      
      protected var var_1568:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         ParamCodeTable.fillTables(this.var_1053,this.var_1568);
         this.var_2093 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1416,const_50);
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1053)
            {
               delete this.var_1053[_loc1_];
            }
            for(_loc1_ in this.var_1568)
            {
               delete this.var_1568[_loc1_];
            }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1417)
         {
            _loc8_ = param1.child(const_1008);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1010).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
            ...
            _loc4_ = param1.child(const_1009);
         ...
         if(param1.localName() == const_1009)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         style = uint(this.parseAttribute(xml,const_1413,variables,style));
         params = uint(this.parseAttribute(xml,const_631,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1407,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_175));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_175));
         rect.width = Number(this.parseAttribute(xml,const_1356,variables,const_175));
         rect.height = Number(this.parseAttribute(xml,const_1357,variables,const_175));
         visible = this.parseAttribute(xml,const_1406,variables,visible.toString()) == const_630;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_631).length() > 0)
         {
            list = xml.child(const_631).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               ...
               if(this.var_1053[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_427)) + "\"!");
               }
               params |= this.var_1053[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_50) : const_50;
         caption = unescape(String(this.parseAttribute(xml,const_1409,variables,caption)));
         if(tag != const_50)
         {
            tags = tag.split(const_1355);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1008)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1418,variables,window.limits.minWidth));
         ...
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1414,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_630;
         blend = Number(this.parseAttribute(xml,const_1213,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1412,variables,window.clipping.toString()) == const_630;
         ...
         list = xml.child(const_1010).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
