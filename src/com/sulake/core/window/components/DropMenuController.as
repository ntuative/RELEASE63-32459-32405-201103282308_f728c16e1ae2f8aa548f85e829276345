package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      protected static const const_421:String = "_DROPMENU_TITLETEXT";
      ...
      private var var_184:DropMenuController;
      ...
      {
         if(param1 > this.var_259.lenght - 1)
         {
            throw new Error("Menu selection index out of range!");
         }
         var _loc2_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_531,this,null,true);
         ...
         if(!_loc2_.isWindowOperationPrevented())
         {
            ...
            this.var_627 = param1;
            this.closeMenuView();
            _loc2_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_348,this,null);
            this.update(this,_loc2_);
         }
         _loc2_.recycle();
      }
      ...
      {
         if(this.var_184 != null && !this.var_184.disposed)
         {
            this.var_184.destroy();
            this.var_184 = null;
         }
         super.dispose();
      }
      ...
      {
         return getChildByName(DropMenuController.const_421) as ILabelWindow;
      }
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_184 == null || this.var_184.disposed)
         {
            this.var_184 = context.create(name + "::submenu","",WindowType.const_540,var_83,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
            this.var_184.setGlobalRectangle(_loc1_);
         }
      ...
      override public function populate(param1:Array) : void
      {
         ...
         {
            this.var_259.push(param1[_loc2_]);
            _loc2_++;
         }
         this.var_946 = true;
         this.closeMenuView();
      ...
      public function getMenuItemIndex(param1:IDropMenuItemWindow) : int
      {
         ...
         if(_loc2_ == -1)
         {
            ...
            {
               _loc2_ = this.var_184.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
      ...
      protected function openMenuView() : void
      {
         if(!this.var_946)
         {
            if(this.open())
            {
               if(this.var_259.length)
               {
                  this.populateMenuItemContainer(this.var_259,this.getSubMenu(),this.subMenuEventProc);
                  this.var_946 = true;
               }
            }
         }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_946 = false;
            this.getTitleLabel().text = this.var_627 < this.var_259.length && this.var_627 > -1 ? this.var_259[this.var_627] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_525,var_83,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_364,var_83,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_627 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_627).setStateFlag(WindowState.const_56,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_41 || param1.type == WindowTouchEvent.const_593)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1056:
            case WindowMouseEvent.const_59:
               ...
               break;
            case WindowTouchEvent.const_831:
      ...
      public function open() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1212,this,null);
      ...
      public function enumerateSelection() : Array
      {
         ...
         if(!_disposed)
         {
            ...
            {
               _loc1_.push(this.var_259[_loc2_]);
               _loc2_++;
            }
         }
         return _loc1_;
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_259.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_661,this.var_259,PropertyStruct.const_144,true));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_661)
            {
