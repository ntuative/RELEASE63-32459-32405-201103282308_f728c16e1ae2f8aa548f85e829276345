package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private var var_342:Object = null;
      ...
      {
         return this.var_342 != null;
      }
      
      protected function get textField() : TextField
      {
         var _loc1_:TextField = TextFieldCache.getTextFieldByStyleName(this.var_403);
         if(_loc1_)
         {
            _loc1_.text = this._text;
            if(this.var_342 != null)
            {
               _loc1_.textColor = uint(this.var_342);
            }
         }
         return _loc1_;
      }
      ...
      {
         if(this.var_403 != param1.name)
         {
            this.var_403 = param1.name;
            this.refresh();
         }
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2215 = _loc2_.textWidth;
         this.var_2214 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_342 != _loc2_.color : this.var_342 != null && this.var_342 != PropertyDefaults.const_796) ? new PropertyStruct(PropertyDefaults.const_392,this.var_342,PropertyStruct.const_156,true) : PropertyDefaults.const_1089);
         if(this.var_39)
         {
            if(this.var_39.left != PropertyDefaults.const_665)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_276,this.var_39.left,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_567);
            }
            if(this.var_39.top != PropertyDefaults.const_733)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_267,this.var_39.top,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_472);
            }
            if(this.var_39.right != PropertyDefaults.const_876)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_238,this.var_39.right,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_537);
            }
            if(this.var_39.bottom != PropertyDefaults.const_709)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_252,this.var_39.bottom,PropertyStruct.const_42,true));
            }
            else
            {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_392:
                  this.var_342 = _loc2_.value as uint;
                  break;
