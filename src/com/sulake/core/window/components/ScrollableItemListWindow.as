package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      override public function dispose() : void
      {
         if(this.var_406)
         {
            this.var_406.removeEventListener(WindowEvent.const_281,this.scrollBarEventProc);
            this.var_406.removeEventListener(WindowEvent.const_237,this.scrollBarEventProc);
            this.var_406 = null;
         }
         if(this.var_1089)
         {
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_406)
         {
            ...
            if(this.var_406)
            {
               this.var_406.addEventListener(WindowEvent.const_281,this.scrollBarEventProc);
               this.var_406.addEventListener(WindowEvent.const_237,this.scrollBarEventProc);
            }
         }
         return this.var_406;
      }
