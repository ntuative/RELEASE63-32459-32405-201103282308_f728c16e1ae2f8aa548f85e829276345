package com.sulake.core.window.components
{
   ...
   public class ActivatorController extends ContainerController
   {
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         else if(param2.type == WindowNotifyEvent.const_777)
         {
            return true;
         }
      ...
      public function setActiveChild(param1:IWindow) : IWindow
      {
         ...
         var _loc2_:IWindow = this.var_855;
         if(this.var_855 != param1)
         {
            if(this.var_855 != null)
            {
               if(!this.var_855.disposed)
               {
                  this.var_855.deactivate();
               }
            }
            this.var_855 = param1;
