package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1397:String = "_SELECTOR";
      
      private static const const_1396:String = "_CONTENT";
       
      
      protected var var_1052:ITabSelectorWindow;
      
      protected var var_2091:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1052 = findChildByTag(const_1397) as ITabSelectorWindow;
            if(this.var_1052 != null)
            {
               this.var_1052.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2091 = findChildByTag(const_1396) as IWindowContainer;
         }
      ...
      {
         return !!this.var_799 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1052.numSelectables;
      }
