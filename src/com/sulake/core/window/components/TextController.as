package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1268:Dictionary = createPropertySetterTable();
      ...
      private var var_403:String = "regular";
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_403,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_403 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_403,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      private static function method_3(param1:TextController, param2:Boolean) : void
      {
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_193);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_692 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_403);
      }
      ...
      {
         this.var_848 = param1;
         this._field.scrollH = this.var_848 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_848 * this.maxScrollH,this.var_555 * this.maxScrollV,width,height);
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_848 = this.var_848;
         _loc1_.var_555 = this.var_555;
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:TextStyle = TextStyleManager.getStyle(this.var_403);
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1163) ? new PropertyStruct(PropertyDefaults.const_829,this._field.antiAliasType,PropertyStruct.const_55,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1233) : PropertyDefaults.const_1656);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1234 ? new PropertyStruct(PropertyDefaults.const_634,this._autoSize,PropertyStruct.const_55,true,PropertyDefaults.const_1077) : PropertyDefaults.const_1625);
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1181 ? new PropertyStruct(PropertyDefaults.const_1093,this._field.gridFitType,PropertyStruct.const_55,true,PropertyDefaults.const_1112) : PropertyDefaults.const_1528);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_796) ? new PropertyStruct(PropertyDefaults.const_392,this._field.textColor,PropertyStruct.const_156,true) : PropertyDefaults.const_1089);
         _loc1_.push(this.var_403 != TextStyleManager.const_193 ? new PropertyStruct(PropertyDefaults.const_381,this.var_403,PropertyStruct.const_55,true,PropertyDefaults.const_706) : PropertyDefaults.const_1192);
         _loc1_.push(this.var_39.left != PropertyDefaults.const_665 ? new PropertyStruct(PropertyDefaults.const_276,this.var_39.left,PropertyStruct.const_42,true) : PropertyDefaults.const_567);
         _loc1_.push(this.var_39.top != PropertyDefaults.const_733 ? new PropertyStruct(PropertyDefaults.const_267,this.var_39.top,PropertyStruct.const_42,true) : PropertyDefaults.const_472);
         _loc1_.push(this.var_39.right != PropertyDefaults.const_876 ? new PropertyStruct(PropertyDefaults.const_238,this.var_39.right,PropertyStruct.const_42,true) : PropertyDefaults.const_537);
         _loc1_.push(this.var_39.bottom != PropertyDefaults.const_709 ? new PropertyStruct(PropertyDefaults.const_252,this.var_39.bottom,PropertyStruct.const_42,true) : PropertyDefaults.const_442);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1024 ? new PropertyStruct(PropertyDefaults.const_693,this._field.mouseWheelEnabled,PropertyStruct.const_39,true) : PropertyDefaults.const_1486);
