package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_456)
         {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_456)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_771,param1.toolTipCaption,PropertyStruct.const_55,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1576);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1130)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_905,param1.toolTipDelay,PropertyStruct.const_264,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1738);
         }
         return param2;
      }
      ...
      {
         this.var_1303 = param1 == null ? "null" : param1;
      }
