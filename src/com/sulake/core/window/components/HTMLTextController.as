package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_1009:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_1008:String = "default";
      
      private var var_1256:String = null;
      
      private var var_1965:StyleSheet = null;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1256 == param2)
         {
            return;
         }
         param1.var_1256 = param2;
         param1.var_1965 = null;
         if(param1.var_1256 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1256);
            param1.var_1965 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_696.indexOf(param1) > -1)
         {
      ...
      {
         return this.var_1008 == LinkTarget.const_32 ? defaultLinkTarget : this.var_1008;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_19);
            _field.styleSheet = this.var_1965;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_897)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_1008 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_741,this.var_1008,PropertyStruct.const_55,true,PropertyDefaults.const_696));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_741)
            {
               this.var_1008 = _loc2_.value as String;
               break;
            }
