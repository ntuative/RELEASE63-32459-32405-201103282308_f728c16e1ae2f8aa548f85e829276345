package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1565:uint = 500;
      ...
      {
         this.var_1303 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1121,var_11);
         }
         return var_21;
      }
      ...
      {
         if(param1.type == WindowTouchEvent.const_593)
         {
            this.focus();
         }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_799 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_393,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_795,false,PropertyStruct.const_39,true) : PropertyDefaults.const_1527);
         _loc1_.push(this.var_1309 != PropertyDefaults.const_1050 ? new PropertyStruct(PropertyDefaults.const_857,this.var_1309,PropertyStruct.const_39,true) : PropertyDefaults.const_1608);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1259 ? new PropertyStruct(PropertyDefaults.const_836,_field.selectable,PropertyStruct.const_39,true) : PropertyDefaults.const_1595);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1045 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_39,true) : PropertyDefaults.const_1642);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_795:
                  ...
                  break;
               case PropertyDefaults.const_1152:
