package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1243:uint = 0;
      
      protected static const TAG_EXCLUDE:String = "_EXCLUDE";
      
      protected static const TAG_INTERNAL:String = "_INTERNAL";
      
      protected static const const_1269:String = "_COLORIZE";
      
      protected static const const_1758:String = "_IGNORE_INHERITED_STYLE";
      
      private static const const_1016:Point = new Point();
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            var_822 = _loc13_.blend;
            var_464 = _loc13_.var_2842;
      ...
      {
         return this.var_692 != null ? this.var_692 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      ...
      {
         var_465 = param1;
         var_238 = !!var_465 ? uint(var_238 | var_559) : uint(var_238 & 16777215);
      ...
      {
         var_559 = param1 << 24;
         var_238 = !!var_465 ? uint(var_559 | var_238) : uint(16777215 & var_238);
         _context.invalidate(this,var_11,WindowRedrawFlag.REDRAW);
      }
      
      public function set blend(param1:Number) : void
      {
         var_822 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         _context.invalidate(this,var_11,WindowRedrawFlag.const_1213);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            _loc2_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_451,this,null);
      ...
      public function set style(param1:uint) : void
      {
         ...
         {
            var_83 = param1;
            _loc2_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_599,this,null);
            this.update(this,_loc2_);
            _loc2_.recycle();
         }
      }
      ...
      public function set clipping(param1:Boolean) : void
      {
         ...
         {
            var_689 = param1;
            _loc2_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_464,this,null);
            this.update(this,_loc2_);
            _loc2_.recycle();
         }
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               this.var_383 = this._parent.rectangle.clone();
               var_62.x = var_11.x;
               var_62.y = var_11.y;
               var_62.width = var_11.width;
               var_62.height = var_11.height;
               _loc4_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_590,this,this._parent);
            ...
            else
            {
               this.var_383.x = 0;
               this.var_383.y = 0;
               this.var_383.width = 0;
               this.var_383.height = 0;
               _loc4_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1069,this,_loc2_);
               this.update(this,_loc4_);
            }
            _loc4_.recycle();
         }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_896,var_11);
            this.var_21.visible = var_317;
         }
         return this.var_21;
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_83,var_20,_context,var_11,null,this.var_692,this.properties,var_851.concat(),_id) as WindowController;
         _loc2_.var_464 = var_464;
         _loc2_.var_177 = this.var_177;
         _loc2_._debug = this._debug;
         _loc2_.var_383 = this.var_383.clone();
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2728 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1205,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_895,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               _loc9_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_556,this,null);
               this.update(this,_loc9_);
               _loc9_.recycle();
            }
            if(_loc6_)
            {
               _loc9_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_200,this,null);
               this.update(this,_loc9_);
               _loc9_.recycle();
            }
         }
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_41:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1247;
                  ...
                  if((var_20 & 0) > 0)
                  {
                     ...
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_284))
                        {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_200:
                  ...
                  if(param1 == this)
                  {
                     _loc6_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_526,this,null);
                     this.notifyChildren(_loc6_);
                     _loc6_.recycle();
                     if(testParamFlag(WindowParam.const_210,WindowParam.const_165))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_205,WindowParam.const_161))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        ...
                        if(testParamFlag(WindowParam.const_581))
                        {
                           this._parent.height += 0 - 0;
                        }
                        var_20 = _loc10_;
                        _loc6_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_335,this._parent,this);
               ...
               case WindowNotifyEvent.const_556:
                  _context.invalidate(this,var_11.union(var_62),WindowRedrawFlag.const_502);
                  if(param1 == this)
                  {
                     _loc6_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1059,this,null);
                     this.notifyChildren(_loc6_);
                     _loc6_.recycle();
                     if(this._parent != null)
                     {
                        _loc6_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_289,this._parent,this);
                        this._parent.update(this,_loc6_);
                        _loc6_.recycle();
                     }
                  }
               ...
               case WindowNotifyEvent.const_358:
                  if(param1 == this)
                  {
                     _loc6_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_777,this,null);
                     this.notifyChildren(_loc6_);
                     _loc6_.recycle();
                     if(this._parent != null)
                     {
               ...
               case WindowNotifyEvent.const_451:
                  _context.invalidate(this,var_11,WindowRedrawFlag.const_1104);
                  break;
               case WindowNotifyEvent.const_599:
                  ...
                  while(--_loc8_ > -1)
                  {
                     ...
                     if(_loc9_.tags.indexOf(const_1758) == -1)
                     {
                        _loc9_.style = var_83;
                     }
                  }
               ...
               case WindowNotifyEvent.const_464:
                  if(!(var_20 & 0))
                  {
                     if(!this.var_21)
                     {
                        ...
                        _context.invalidate(this,var_11,WindowRedrawFlag.const_502);
                     }
                  }
                  else if(var_20 & 0)
                  {
               ...
               case WindowNotifyEvent.const_526:
                  this._parent.getRegionProperties(null,this.var_383);
                  this.updateScaleRelativeToParent();
                  break;
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1122:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1582:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_1253:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1251:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_698:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1212:
               _loc2_ = "null";
               _loc4_ = true;
               break;
         ...
         if(this.var_177 && var_464 > 0)
         {
            if(!testParamFlag(WindowParam.const_33))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(const_1016,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(const_1016,param3,param1)) : false;
            }
         }
      ...
      public function setStateFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(_state != _loc3_)
         {
            _loc4_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_451,this,null);
            this.update(this,_loc4_);
            _loc4_.recycle();
         }
      }
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_83 != _loc3_)
         {
            _loc4_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_599,this,null);
            this.update(this,_loc4_);
            _loc4_.recycle();
         }
      }
      ...
      public function setParamFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_20 != _loc3_)
         {
            _loc4_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_464,this,null);
            this.update(this,_loc4_);
            _loc4_.recycle();
         }
      }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_159,WindowParam.const_165);
         var _loc2_:* = !testParamFlag(WindowParam.const_133,WindowParam.const_161);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this._parent.width - this.var_383.width;
            ...
            if(_loc2_)
            {
               _loc4_ = this._parent.height - this.var_383.height;
               _loc5_ = uint(var_20 & 0);
      ...
      {
         if(_state == WindowState.const_551)
         {
            return true;
         }
         _state = WindowState.const_551;
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1253,this,null);
      ...
      public function minimize() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_1184;
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      {
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1073,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      {
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1209,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1145,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function enable() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1226,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_698;
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function focus() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1177,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.type = WindowNotifyEvent.const_1123;
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         var _loc3_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_357,this,param1);
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         var _loc4_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_357,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         var _loc4_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_674,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
