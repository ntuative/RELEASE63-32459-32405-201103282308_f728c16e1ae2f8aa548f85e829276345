   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_247 != null)
         {
            ...
            {
               _loc3_ = this.var_247.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      {
         if(this.var_1370.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
      ...
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         ...
         if(this.var_247.getValue(_loc2_) != null)
         {
            return this.var_247.getValue(_loc2_) as IRoomObjectManager;
         }
         if(this._container == null)
         {
            return null;
         ...
         if(_loc3_ != null)
         {
            this.var_247.add(_loc2_,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         return this.var_247.getValue(String(param1)) as IRoomObjectManager;
      }
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(this.var_247.getValue(_loc2_) != null)
         {
            _loc3_ = this.var_247.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
