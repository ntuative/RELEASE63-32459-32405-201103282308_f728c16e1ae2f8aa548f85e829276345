package com.sulake.room.object
{
   ...
   public class RoomObject implements IRoomObjectController
   {
      ...
      {
         this.var_1808.assign(this.var_91);
         return this.var_1808;
      }
      
      public function getDirection() : IVector3d
      {
         this.var_1809.assign(this.var_373);
      ...
      public function setDirection(param1:IVector3d) : void
      {
         ...
         if(this.var_373.x != param1.x || this.var_373.y != param1.y || this.var_373.z != param1.z)
         {
            this.var_373.x = (param1.x % 360 + 360) % 360;
            this.var_373.y = (param1.y % 360 + 360) % 360;
            this.var_373.z = (param1.z % 360 + 360) % 360;
            ++this._updateID;
         }
      }
