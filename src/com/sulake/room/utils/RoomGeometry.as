package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_842:Number = 64;
      
      public static const const_1248:Number = 32;
      ...
      private var var_373:Vector3d;
      
      private var var_2894:Number = -500.0;
      
      private var var_2893:Number = 500.0;
      ...
      {
         this.var_1891.assign(this.var_170);
         return this.var_1891;
      }
      
      public function get location() : IVector3d
      {
         this.var_524.assign(this.var_91);
         this.var_524.x *= this.var_438;
         this.var_524.y *= this.var_436;
         this.var_524.z *= this.var_437;
         return this.var_524;
      }
      
      public function get direction() : IVector3d
      {
         this._direction.assign(this.var_373);
         return this._direction;
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_438 != param1 * this.var_1890)
         {
            this.var_438 = param1 * this.var_1890;
            ++this.var_166;
         }
      }
      ...
      {
         if(this.var_436 != param1 * this.var_1889)
         {
            this.var_436 = param1 * this.var_1889;
            ++this.var_166;
         }
      }
      ...
      {
         if(this.var_437 != param1 * this.var_1888)
         {
            this.var_437 = param1 * this.var_1888;
            ++this.var_166;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_91.x /= this.var_438;
         this.var_91.y /= this.var_436;
         this.var_91.z /= this.var_437;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_373.x;
         var _loc3_:Number = this.var_373.y;
         var _loc4_:Number = this.var_373.z;
         this.var_373.assign(param1);
         if(this.var_373.x != _loc2_ || this.var_373.y != _loc3_ || this.var_373.z != _loc4_)
         {
            ++this.var_166;
         }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1203.assign(_loc22_);
         }
         else
         {
            this.var_1203.assign(_loc17_);
         }
         ++this.var_166;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1203);
         if(_loc3_ < this.var_2894 || _loc3_ > this.var_2893)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_436;
            _loc2_.z *= this.var_437;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1203);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_91.x * this.var_438,this.var_91.y * this.var_436,this.var_91.z * this.var_437);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_170;
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1248;
         }
         else
         {
            this.scale = const_842;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_842;
      }
