package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_347:int = 50;
      
      private static const const_1442:int = 50;
      
      private static const const_1022:Number = 60;
      ...
      private var var_674:RoomObjectCache;
      ...
      private var var_2810:Number = -1.0E7;
      
      private var var_2809:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_274.addChild(this.var_101);
         ...
         this.var_273 = new BitmapDataCache(1024 * 1024 * 16);
         var _loc6_:* = null;
         ...
         this.var_674 = new RoomObjectCache(_loc6_);
         this.var_1028 = new ColorTransform();
         this.var_1029 = new Matrix();
      ...
      {
         this.var_547.x -= param1 - this.var_677;
         this.var_677 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_547.y -= param1 - this.var_676;
         this.var_676 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         if(param1 && !this.var_891)
         {
            ...
            if(this.var_144 != null && !this.var_274.contains(this.var_144))
            {
               ...
               this.var_101.mask = this.var_144;
            }
         }
      ...
      {
         this.var_674.removeObjectCache(param1);
      }
      
      public function render(param1:int) : void
      {
         this.var_2013 = !this.var_2013;
         ...
         if(this.var_834 != this.var_2811 || this.var_835 != this.var_2814)
         {
            _loc8_ = true;
         }
         if(this.var_101.x != this.var_677 || this.var_101.y != this.var_676)
         {
            this.var_101.x = this.var_677;
            this.var_101.y = this.var_676;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_2811 = this.var_834;
         this.var_2814 = this.var_835;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1539 > 0)
         {
            _loc2_ = param1 - this.var_1539;
            if(_loc2_ > const_1022 * 3)
            {
               Logger.log("Really slow frame update " + _loc2_ + "ms");
               this.var_2812 = _loc2_;
            }
            if(_loc2_ <= MAXIMUM_VALID_FRAME_UPDATE_INTERVAL)
            {
               ++this.var_837;
               if(this.var_837 == const_347 + 1)
               {
                  this.var_501 = _loc2_;
                  this.var_2014 = this.var_2813;
               }
               else if(this.var_837 > const_347 + 1)
               {
                  _loc3_ = Number(this.var_837 - const_347);
                  this.var_501 = this.var_501 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_2014 = this.var_2014 * (_loc3_ - 1) / _loc3_ + Number(this.var_2813) / _loc3_;
                  if(this.var_837 > const_347 + const_1442)
                  {
                     this.var_837 = const_347;
                     if(!this.var_1278 && this.var_501 > const_1022)
                     {
                        this.var_1278 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1278 && this.var_501 < const_1443)
                     {
                        this.var_1278 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_674.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_674.getObjectCache(param2);
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_2013 && this.var_1278);
         ...
         _loc13_ += int(this.var_834 / 2);
         _loc14_ += int(this.var_835 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_677;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_676;
                  if(_loc19_ < this.var_834 && _loc19_ + _loc22_.width >= 0 && (_loc20_ < this.var_835 && _loc20_ + _loc22_.height >= 0))
                  {
                     ...
                     _loc17_.x = _loc19_ - this.var_677;
                     _loc17_.y = _loc20_ - this.var_676;
      ...
      {
         if(param1 < 0 || param1 >= this.var_1027)
         {
            return null;
         }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(param2 < 0 || param2 >= this.var_1027)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         if(param1 < this.var_836 || this.var_836 == 0)
         {
            _loc4_ = this.var_1027 - 1;
            while(_loc4_ >= param1)
            {
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:int) : BitmapData
      {
         ...
         if(param3 && param4 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc5_ = this.var_273.getBitmapData(_loc6_);
            }
            if(_loc5_ == null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_273.addBitmapData(_loc6_,_loc5_);
                  }
                  return _loc5_;
               }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            this.var_1029.identity();
            this.var_1029.scale(-1,1);
            this.var_1029.translate(data.width,0);
            finalData.draw(data,this.var_1029);
            if(name.length > 0)
            {
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            {
               finalData = new ExtendedBitmapData(data.width,data.height,true,16777215);
               finalData.copyPixels(data,data.rect,const_606);
            }
            catch(e:Error)
            {
               finalData = new ExtendedBitmapData(1,1,true,16777215);
            }
            this.var_1028.redMultiplier = tR;
            this.var_1028.greenMultiplier = tG;
            this.var_1028.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_1028);
            if(name.length > 0)
            {
               this.var_273.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         ...
         if(this.var_1277 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_2012;
         }
         this.var_2012 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1277;
         return this.var_2012;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_834 / 2;
         var _loc12_:Number = param2 - this.var_835 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_2011,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_675.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_675.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2810 || param2 != this.var_2809)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_675.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_675.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
