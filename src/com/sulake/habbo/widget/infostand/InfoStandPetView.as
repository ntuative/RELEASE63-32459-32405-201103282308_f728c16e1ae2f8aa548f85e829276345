package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_2056:int = 16;
      ...
      private const const_2054:uint = 2085362;
      
      private const const_2050:uint = 39616;
      
      private const const_2053:uint = 10513106;
      
      private const const_2049:uint = 8734654;
      
      private const const_2058:uint = 9094430;
      
      private const const_2061:uint = 6200576;
      
      private const const_2055:String = "happiness";
      
      private const const_2057:String = "experience";
      ...
      {
         if(this.var_53 == null || this.var_197 == null || this.var_67 == null)
         {
            return;
         }
         ...
         this.var_197.height = this.var_53.height + 20;
         this._window.width = Math.max(this.var_197.width,this.var_67.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_197.width < this.var_67.width)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_2055,param1.nutrition,param1.nutritionMax,this.const_2050,this.const_2054);
         this.updateStateElement(this.const_2057,param1.experience,param1.experienceMax,this.const_2049,this.const_2053);
         this.updateStateElement(this.const_2052,param1.energy,param1.energyMax,this.const_2061,this.const_2058);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_2060,this.const_2056,false);
         ...
         var _loc9_:Rectangle = new Rectangle(1,1 + this.const_1288,_loc7_.width - 2,_loc7_.height - 2 - this.const_1288);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,this.const_1288);
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_53 = this.var_197.findChildByName("infostand_element_list") as IItemListWindow;
         }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_196 && this.var_196.getPetId() == this.var_482)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1464,true);
