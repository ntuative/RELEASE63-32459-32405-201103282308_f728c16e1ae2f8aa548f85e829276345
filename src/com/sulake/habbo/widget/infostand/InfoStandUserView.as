package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_1269:TagListRenderer;
      
      private var var_137:IBorderWindow;
      
      private var var_2653:int;
      
      private const const_989:int = 5;
      
      private const const_1799:int = 39;
      
      private const const_1798:int = 7829367;
      
      private const const_1797:int = 16777215;
      
      private const const_2081:int = 2000;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1269 = new TagListRenderer(param1,this.onTagSelected);
      }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_989;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            if(param1 == "")
            {
               ...
               _loc3_.textColor = this.const_1798;
            }
            else
            {
               _loc3_.textColor = this.const_1797;
            }
            _loc3_.enable();
         }
         else
         ...
         _loc3_.text = param1;
         _loc3_.height = _loc3_.textHeight + this.const_989;
         if(param2)
         {
            _loc3_.addEventListener(WindowKeyboardEvent.const_373,this.onMottoKeyboard);
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc3_.removeEventListener(WindowKeyboardEvent.const_373,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1269.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_1057:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_1262:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2653 > this.const_2081 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2653 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1798;
            if(_loc3_.length >= this.const_1799)
            {
               _loc2_.text = _loc3_.substring(0,this.const_1799 - 1);
            }
         }
      }
