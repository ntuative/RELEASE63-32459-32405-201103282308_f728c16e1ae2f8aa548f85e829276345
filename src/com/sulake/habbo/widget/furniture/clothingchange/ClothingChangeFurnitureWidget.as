package com.sulake.habbo.widget.furniture.clothingchange
{
   ...
   public class ClothingChangeFurnitureWidget extends RoomWidgetBase
   {
      ...
      private static const const_987:String = "Boy";
      
      private static const const_986:String = "Girl";
      ...
      private function showGenderSelectionInterface(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         ...
         this.var_2544 = param1.objectCategory;
         ...
         _loc4_ = this._window.findChildByName(const_987);
         if(_loc4_ != null)
         {
      ...
      private function hideEditorInterface() : void
      {
         ...
         {
            _loc1_ = this.var_791 as IFrameWindow;
            if(_loc1_ != null)
            {
      ...
      private function requestEditor(param1:String) : void
      {
         ...
         this.var_791 = _loc4_;
         this.var_791.offset(100,100);
         var _loc6_:IWindow = this.var_791.findChildByTag("close");
         if(_loc6_ != null)
         {
            _loc6_.procedure = this.onEditorWindowClose;
         }
         var _loc7_:* = null;
         _loc7_ = new RoomWidgetClothingChangeMessage(RoomWidgetClothingChangeMessage.const_406,param1,this.var_391,this.var_2544,this._roomId,this._roomCategory,_loc5_);
