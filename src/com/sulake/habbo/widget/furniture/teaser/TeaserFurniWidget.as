package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1759:int = 1;
      
      private const const_1764:int = 2;
      
      private const const_1760:int = 3;
      
      private const const_1762:int = 4;
      
      private const const_2042:int = 0;
      
      private const const_2044:int = 1;
      
      private const const_2043:int = 2;
      
      private const const_2047:int = 3;
      
      private const const_2041:int = 4;
      
      private const const_2045:int = 5;
      
      private const const_1765:String = "deco_img";
      
      private const const_1763:String = "dialog_bg";
      
      private const const_2046:String = "%campaign%_dialog_bg.png";
      
      private const const_337:String = "%campaign%_gift_package.png";
      
      private const const_2040:String = "%campaign%_gift_content.png";
      
      private const const_2039:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboInventory)
      {
         ...
         this.var_1317 = this.var_174.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1317 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1320.length)
         {
            _loc2_ = this.var_1320.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_174 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_545,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_657,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_729,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_545,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_545:
               _loc2_ = this.const_1761;
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_729:
               ...
               this._shareId = null;
               this.var_1319 = param1.itemCategory;
               break;
         ...
         if(this._window && (this.var_1318 != _loc2_ || _loc3_ != this.var_178))
         {
            this._window.dispose();
            this._window = null;
         }
         ...
         if(!this._window)
         {
            switch(this.var_1318)
            {
               ...
               case this.const_1759:
                  ...
                  else if(this.var_397 == this.const_2044)
                  {
                     ...
                     _loc2_ = this.const_2040;
                  }
                  else if(this.var_397 == this.const_2043)
                  {
                  ...
                  else if(this.var_397 == this.const_2047)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  ...
                  else if(this.var_397 == this.const_2041)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_178,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_397 == this.const_2045)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2046.replace("%campaign%",this.var_178);
            this.setDecoImage(_loc5_,this.const_1763);
            _loc2_ = _loc2_.replace("%campaign%",this.var_178);
            this.setDecoImage(_loc2_,this.const_1765);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_921);
      ...
      private function onPostButton(param1:WindowEvent) : void
      {
         ...
         var _loc4_:String = this.var_174.getKey("viral.furni.post_type","feed");
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this._inventory)
         {
            if(this.var_1319 != 0)
            {
               this._inventory.toggleInventoryPage(this.var_1319 == 1 ? "null" : InventoryCategory.const_145);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_906,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1320.push(new ImageDownloader(this,_assets,this.var_178,this.var_1317,param1,param2));
            return;
         }
