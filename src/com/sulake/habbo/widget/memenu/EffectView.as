package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2087:int = 1000;
      ...
      {
         super();
         this.var_206 = new Timer(this.const_2087);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_191.isActive)
         {
            ...
            this.var_1011.width = _loc2_ * this.var_325;
         }
         else
         {
            this.var_1011.width = 0;
            this.var_206.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_819 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_819 == null)
            {
               return;
            }
         ...
         if(!this.var_191.isActive)
         {
            this.var_819.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_819.caption = "${widgets.memenu.effects.active.timeleft}";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.setTimeLeft();
         this.var_1011 = this._window.findChildByName("loader_bar");
         if(this.var_1011 != null)
         {
            this.var_325 = this.var_1011.width;
            this.var_206.start();
            this.onUpdate();
         }
