package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      {
         this.var_296 = param2 as IHabboCommunicationManager;
         if(this.var_296 == null)
         {
            return;
         }
         this._connection = this.var_296.getHabboMainConnection(this.onConnectionReady);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2706 = this._config.getKey("interstitial.enabled","false") == "true";
         this.var_2707 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2708 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1936 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_1936 > 0 && this.var_1937 >= this.var_1936)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1234;
         if(_loc1_ > this.var_2707)
         {
            ++this.var_1937;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         if(this.var_1498 != "")
         {
            ...
            {
               this.var_230 = new Timer(this.var_2708,1);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_488,0,0,param1.bitmapData,this.var_2705));
            this.var_1234 = getTimer();
         }
         else
         {
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1935 = _loc2_.clickUrl;
         if(this.var_1497 != "" && this.var_1935 != "")
         {
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_481,0,0,_loc4_,this.var_1935,this.var_1235,this.var_1236));
         }
      }
