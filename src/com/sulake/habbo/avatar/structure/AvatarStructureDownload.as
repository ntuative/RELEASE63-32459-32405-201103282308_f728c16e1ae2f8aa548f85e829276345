package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      public static const const_1035:String = "AVATAR_STRUCTURE_DONE";
       
      
      private var var_2766:IStructureData;
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         this.var_2766.appendXML(this.var_1995);
         dispatchEvent(new Event(AvatarStructureDownload.const_1035));
      }
   }
}
