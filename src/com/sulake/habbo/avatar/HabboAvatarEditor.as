package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1444:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1445:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_812:ISessionDataManager;
      
      private var _view:AvatarEditorView;
      
      private var var_1281:AvatarEditorHandler;
      ...
      private var var_1033:IFigureData;
      ...
      private var var_1541:IHabboAvatarEditorDataSaver = null;
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_195)
         {
            ...
            _loc2_.loadAvatarData(const_1444,FigureData.const_83);
            _loc3_.loadAvatarData(const_1445,FigureData.FEMALE);
            this.var_102 = new Map();
            this.var_551 = new Map();
            this.var_102.add(AvatarEditorFigureCategory.const_652,new BodyModel(this));
            this.var_102.add(AvatarEditorFigureCategory.const_51,new HeadModel(this));
            this.var_102.add(AvatarEditorFigureCategory.const_223,new TorsoModel(this));
            this.var_102.add(AvatarEditorFigureCategory.const_715,new LegsModel(this));
            ...
            this.var_551.add(AvatarEditorSideCategory.const_105,new WardrobeModel(this));
            this.var_551.add(AvatarEditorSideCategory.const_597,new ClubPromoModel(this));
            this.var_195 = true;
         }
      }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_1033.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_1033.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_277 == null)
            {
               this.var_277 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_73,HabboWindowStyle.const_32,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_277.addChild(this._view.window);
               if(param5)
               {
                  this.var_277.center();
               }
            ...
            this.var_277.visible = !this.var_277.visible;
         }
         this._view.show();
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_652);
         }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_812 = param2 as ISessionDataManager;
      }
      ...
      {
         this.var_1033 = this.var_550.getFigureData(AvatarType.const_119);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1281 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_682[this.var_935];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1541 != null)
         {
            ...
            this.var_1541.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_2018;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1282 >= _loc13_.clubLevel))
               {
                  ...
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1559.clone() as IWindowContainer,param1,_loc13_);
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1293.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1592)
               {
                  _loc23_ = true;
               }
               ...
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1293.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_551.getValue(AvatarEditorSideCategory.const_105);
      }
