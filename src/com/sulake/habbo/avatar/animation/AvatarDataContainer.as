package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_2003:Number = 1.0;
      
      private var var_2005:Number = 1.0;
      
      private var var_2004:Number = 1.0;
      
      private var _alphaMultiplier:Number = 1.0;
      
      private var var_1241:Map;
      ...
      {
         super();
         this.var_1955 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2721 = parseInt(_loc2_,16);
         this.var_2723 = parseInt(_loc3_,16);
         ...
         this.var_1028 = new ColorTransform(this.var_2003,this.var_2005,this.var_2004,this._alphaMultiplier);
         this.var_1241 = this.generatePaletteMapForGrayscale(this.var_2723,this.var_2721);
      }
      ...
      {
         return this.var_1241.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1241.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1241.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1241.getValue("alphas") as Array;
      }
