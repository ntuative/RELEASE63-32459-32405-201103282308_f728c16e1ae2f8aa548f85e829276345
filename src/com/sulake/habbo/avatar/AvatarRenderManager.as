package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2090:String = "hd-99999-99999";
      ...
      private var var_2010:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_596 = RenderMode.const_1647;
         ...
         this.var_110.add(AvatarType.const_119,_loc4_);
         ...
         this.var_110.add(AvatarType.const_64,_loc4_);
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc1_ in this.var_110.getValues())
            {
               _loc1_.dispose();
            }
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_323.init();
         this.var_833.init();
         _loc2_ = this.var_110.getValue(AvatarType.const_119) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_110.getValue(AvatarType.const_64) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_110.getValue(AvatarType.const_119) as AvatarStructure;
            if(_loc3_ != null)
            {
               ...
               _loc5_.addEventListener(AvatarStructureDownload.const_1035,this.onFigureDataDownloadDone);
      ...
      private function checkIfReady() : void
      {
         if(!this.var_994)
         {
            if(this.var_2807 && this.var_2806 && this.var_2805)
            {
      ...
      {
         var _loc5_:AvatarStructure = this.var_110.getValue(AvatarType.const_119) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_2010)
         {
            this.var_2010 = new AvatarFigureContainer(this.const_2090);
         }
         this.var_235.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_2010,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         for each(_loc3_ in this.var_322.getKeys())
         {
            _loc4_ = this.var_322.getValue(_loc3_);
            if(_loc4_ != null)
            {
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1639)
         {
            _loc6_ = !this.var_323.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_323.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_110.getValue(AvatarType.const_64) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = this.var_110.getValue(AvatarType.const_64);
      ...
      {
         var _loc2_:AvatarStructure = this.var_110.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc3_:AvatarStructure = this.var_110.getValue(AvatarType.const_119) as AvatarStructure;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_64:
               _loc3_ = this.var_110.getValue(AvatarType.const_64) as AvatarStructure;
               break;
            default:
