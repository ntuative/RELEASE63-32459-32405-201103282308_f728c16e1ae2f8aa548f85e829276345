package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1796:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1357:IAvatarImage;
      ...
      private var var_431:AvatarImageBodyPartContainer;
      
      private var var_1477:String;
      
      private var var_120:AvatarImagePartContainer;
      
      private var var_2642:Point;
      ...
      private var var_2641:ByteArray;
      
      private var var_2643:ImageData;
      
      private var var_999:PaletteMap;
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_789 == GeometryType.const_1052 && param1 == GeometryType.const_1117 || this.var_789 == GeometryType.const_1117 && param1 == GeometryType.const_1052)
         {
            this.var_789 = param1;
            this.var_87 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
            ...
            if(this.var_372.definition.isAnimation)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     ...
                     if(_loc14_.type == AnimationLayerData.const_699)
                     {
                        if(_loc14_.action != null)
                        {
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1357.getFigure(),_loc5_,this.var_789,_loc3_,_loc6_,_loc7_);
            _loc10_ = new AvatarImageDirectionCache(_loc15_);
            _loc9_.updateDirectionCache(_loc3_,_loc10_);
         }
         this.var_431 = _loc10_.getImageContainer(_loc4_);
         if(this.var_431 == null)
         {
            _loc16_ = _loc10_.getPartList();
            this.var_431 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_372);
            if(this.var_431 == null)
            {
               return null;
            }
            _loc10_.updateImageContainer(this.var_431,_loc4_);
         }
         this.var_431.offset = _loc8_;
         return this.var_431;
      }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_87)
         {
            this.var_87 = this._structure.getCanvas(this._scale,this.var_789);
            if(!this.var_87)
            {
               return null;
            }
            this.var_2642 = new Point(0,this.var_87.height - int(this.var_87.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1555[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_886 || _loc10_ == AvatarAction.const_404;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1477 = this.var_120.bodyPartId;
               this.var_186 = this.var_120.partType;
               this.var_1877 = this.var_120.partId;
               ...
               this.var_1476 = this._scale + "_" + this.var_120.action.assetPartDefinition + "_" + this.var_186 + "_" + this.var_1877 + "_" + _loc5_ + "_" + this._frame;
               this.var_433 = this._assets.getAssetByName(this.var_1476) as BitmapDataAsset;
               if(this.var_433 == null)
               {
                  this.var_1476 = this._scale + "_std_" + this.var_186 + "_" + this.var_1877 + "_" + _loc5_ + "_0";
                  this.var_433 = this._assets.getAssetByName(this.var_1476) as BitmapDataAsset;
               }
               if(!(!this.var_433 || !this.var_433.content))
               {
                  if(this.var_120.paletteMapId > -1)
                  {
                     this.var_999 = this._structure.renderManager.paletteManager.getPalette(this.var_120.paletteMapId);
                     if(this.var_999 != null)
                     {
                        this.var_965 = this.var_433.content as BitmapData;
                        this.var_187 = new BitmapData(this.var_965.width,this.var_965.height);
                        this.var_2641 = this.var_999.colorize(this.var_965.getPixels(this.var_965.rect));
                        this.var_187.setPixels(this.var_187.rect,this.var_2641);
                     }
                     else
                     {
                        this.var_187 = (this.var_433.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1477 == AvatarBodyPartType.const_223 || this.var_1477 == AvatarBodyPartType.const_1541 || this.var_1477 == AvatarBodyPartType.const_1551) && this.var_120.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  {
                     this.var_187.colorTransform(this.var_187.rect,this.var_120.color.colorTransform);
                  }
                  if(this.var_120.isBlendable)
                  {
                     this.var_187.colorTransform(this.var_187.rect,this.var_120.blendTransform);
                  }
                  this.var_966 = this.var_433.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_57)
                     {
                  ...
                  this.var_2643 = new ImageData(this.var_187,this.var_966,_loc7_);
                  this.var_964.push(this.var_2643);
               }
            }
            _loc8_--;
         }
         ...
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2642.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_57)
            {
