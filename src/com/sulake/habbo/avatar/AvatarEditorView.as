package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1293:IWindowContainer;
      
      public static var var_1559:IWindowContainer;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1162 = [];
         this.var_1385 = [AvatarEditorFigureCategory.const_652,AvatarEditorFigureCategory.const_51,AvatarEditorFigureCategory.const_223,AvatarEditorFigureCategory.const_715,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_105];
         super();
         ...
         if(var_1293 == null)
         {
            ...
            var_1293 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1559 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1559 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_428 = new Timer(1000);
         this.var_428.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1385;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1385);
         }
         if(param1.length != this.var_1162.length)
         {
            return false;
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2514 = this.canChangeOutfit();
            this.var_428.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         while(_loc2_ >= 0)
         {
            ...
            if(_loc4_ != null && this.var_1162.indexOf(_loc4_.name) < 0)
            {
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1385;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_44) && (this.var_1805 == AvatarEditorSideCategory.const_105 || this.var_2513))
         {
      ...
      {
         if(this.var_1805 == AvatarEditorSideCategory.const_105)
         {
            this.var_2513 = false;
            this.setSideContent(AvatarEditorSideCategory.const_883);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_883:
               break;
            case AvatarEditorSideCategory.const_597:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_597);
               break;
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "save":
                  ...
                  this.var_2402 = new Date().valueOf();
                  this.var_2514 = false;
                  this.var_428.start();
      ...
      private function canChangeOutfit() : Boolean
      {
         ...
         return _loc1_ - this.var_2402 > 5000;
      }
   }
}
