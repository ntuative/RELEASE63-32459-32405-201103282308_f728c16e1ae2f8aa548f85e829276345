package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2178 = parseInt(param1.@precedence);
         this.var_2180 = String(param1.@activepartset);
         this.var_2173 = String(param1.@assetpartdefinition);
         this.var_2177 = String(param1.@lay);
         this.var_789 = String(param1.@geometrytype);
         this.var_2175 = Boolean(parseInt(param1.@main));
         this.var_2176 = Boolean(parseInt(param1.@method_6));
         this.var_2179 = Boolean(parseInt(param1.@animation));
