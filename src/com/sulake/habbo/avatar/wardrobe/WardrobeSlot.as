package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      public function updateView() : void
      {
         ...
         if(this.var_618 && this.var_1423)
         {
            _loc5_ = this._controller.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_90,this.var_935,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_36,parseInt(FigureData.const_855));
         ...
         if(_loc4_)
         {
            _loc4_.visible = this.var_1423 && this.var_618 != null;
         }
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "set_button":
               ...
               this._controller.handler.saveWardrobeOutfit(this.var_1782,this);
               this.updateView();
               break;
            case "get_button":
               if(this.var_618)
               {
                  this._controller.loadAvatarInEditor(this.var_618,this.var_935,this._controller.clubMemberLevel);
               }
         }
      }
