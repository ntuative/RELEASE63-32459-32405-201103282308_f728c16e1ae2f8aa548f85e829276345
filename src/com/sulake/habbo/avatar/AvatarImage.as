package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1286:String = "Default";
      
      private static const const_1287:int = 2;
      
      private static const const_1285:String = AvatarSetType.const_36;
      ...
      protected var var_557:IAvatarDataContainer;
      ...
      private var var_2170:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1285,const_1287);
         this.var_330 = new Array();
         this.var_1020 = new ActiveActionData(AvatarAction.const_400);
         this.var_1020.definition = this._structure.getActionDefinition(const_1286);
         this.resetActions();
      ...
      public function dispose() : void
      {
         ...
         if(!this.var_711)
         {
            ...
            if(this.var_702)
            {
               for each(_loc2_ in this.var_702)
               {
                  _loc2_.dispose();
               }
      ...
      {
         param2 += this.var_1613;
         if(param2 < AvatarDirectionAngle.const_1229)
         {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_573,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_242.length == 1 && this.var_89 == this.var_1605)
         {
            return this.var_89 + this.var_475 + this.var_573 % 4;
         }
         if(this.var_242.length == 2)
         {
            for each(_loc1_ in this.var_242)
            {
               ...
               {
                  return this.var_89 + this.var_475 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_573 % 11;
                  return this.var_89 + "_" + this.var_1605 + this.var_475 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2169 || param2 != this.var_2171 || param1 != this.var_2170)
         {
            this.var_2169 = param3;
            this.var_2171 = param2;
            this.var_2170 = param1;
            this.var_1612 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1298 || this.var_45 == null || (this.var_45.width != _loc5_.width || this.var_45.height != _loc5_.height))
         {
            if(this.var_45 != null && !this.var_1298)
            {
               this.var_45.dispose();
            }
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_573);
         ...
         {
            if(this.var_557.paletteIsGrayscale)
            {
               ...
               this.var_45 = _loc13_;
               this.var_45.paletteMap(this.var_45,this.var_45.rect,new Point(0,0),this.var_557.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_573);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_330.push(new ActiveActionData(param1,param2,this.var_573));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_282 = this.var_1020;
         this.var_282.definition = this.var_1020.definition;
      ...
      private function isHeadTurnPreventedByAction() : Boolean
      {
         ...
         for each(_loc3_ in this.var_242)
         {
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_475 = "";
         this.var_242 = this._structure.sortActions(this.var_330);
         if(this.var_242 == null)
         {
         ...
         {
            this.var_703 = this._structure.getCanvasOffsets(this.var_242,this._scale,this.var_89);
            for each(_loc4_ in this.var_242)
            {
               this.var_475 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_291)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1335 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1335 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1337 != this.var_475)
            {
               _loc1_ = true;
               this.var_1337 = this.var_475;
            }
         }
         this.var_1336 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_242)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_975 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1613 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_557 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_313 || _loc1_.actionType == AvatarAction.const_261 || _loc1_.actionType == AvatarAction.const_404)
               {
                  this.var_975 = true;
               }
            }
