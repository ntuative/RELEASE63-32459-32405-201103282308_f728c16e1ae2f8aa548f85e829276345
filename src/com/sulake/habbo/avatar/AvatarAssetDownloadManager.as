package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadManager extends EventDispatcher
   {
      ...
      private var var_984:int = 3;
      
      private var var_441:AssetLoaderStruct;
      ...
      private const const_2083:int = 100;
      ...
      public function AvatarAssetDownloadManager(param1:IAssetLibrary, param2:String, param3:String, param4:AvatarStructure)
      {
         ...
         if(_loc6_ == null)
         {
            this.var_441 = this._assets.loadAssetFromFile("figuremap",_loc5_,"text/xml");
         ...
         this.var_983 = new Timer(this.const_2083,1);
      ...
      private function addMapLoaderEventListeners() : void
      {
         if(this.var_441)
         {
            this.var_441.addEventListener(AssetLoaderEvent.const_30,this.onConfigurationComplete);
            this.var_441.addEventListener(AssetLoaderEvent.const_49,this.onConfigurationError);
         }
      }
      ...
      private function removeMapLoaderEventListeners() : void
      {
         if(this.var_441)
         {
            this.var_441.removeEventListener(AssetLoaderEvent.const_30,this.onConfigurationComplete);
            this.var_441.removeEventListener(AssetLoaderEvent.const_49,this.onConfigurationError);
         }
      }
      ...
      private function onConfigurationError(param1:Event) : void
      {
         ...
         {
            Logger.log("Could not download figuremap.xml. Retries left: " + this.var_984);
            if(this.var_1491.indexOf("?") > 0)
            {
               _loc2_ = this.var_1491 + "&retry=" + this.var_984;
            }
            else
            {
               _loc2_ = this.var_1491 + "?retry=" + this.var_984;
            ...
            this.var_441 = this._assets.loadAssetFromFile("figuremap",_loc3_,"text/xml");
            this.addMapLoaderEventListeners();
         }
      }
      ...
      private function loadFigureMapData(param1:XML) : void
      {
         ...
         this.var_1909 = true;
         for each(_loc2_ in this.var_1224)
         {
      ...
      private function generateMap(param1:XML) : void
      {
         ...
         {
            _loc3_ = new AvatarAssetDownloadLibrary(_loc2_.@id,_loc2_.@revision,this.var_2683,this._assets);
      ...
      public function loadFigureSetData(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         if(!this.var_1909)
         {
            this.var_1224.push([param1,param2]);
            return;
         }
      ...
      private function libraryComplete(param1:Event) : void
      {
         ...
         var _loc10_:* = null;
         var _loc2_:* = [];
         for(_loc3_ in this.var_982)
         {
            _loc7_ = true;
            _loc4_ = this.var_982[_loc3_];
         ...
         {
            delete this.var_982[_loc3_];
         }
         while(_loc6_ < this.var_802.length)
         {
            _loc5_ = this.var_802[_loc6_];
            if(_loc5_.libraryName == (param1.target as AvatarAssetDownloadLibrary).libraryName)
            {
               this.var_802.splice(_loc6_,1);
            }
            _loc6_++;
         }
         this.var_983.start();
      ...
      {
         var _loc1_:* = null;
         while(this.var_801.length > 0 && this.var_802.length < this.const_1664)
         {
            _loc1_ = this.var_801[0];
            _loc1_.startDownloading();
            this.var_802.push(this.var_801.shift());
         }
      }
      
      private function addToQueue(param1:AvatarAssetDownloadLibrary) : void
      {
         if(!param1.isReady && this.var_801.indexOf(param1) == -1 && this.var_802.indexOf(param1) == -1)
         {
