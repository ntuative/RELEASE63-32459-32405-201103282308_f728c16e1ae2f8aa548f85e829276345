package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      private const const_2091:int = 2;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_245)
         {
            for each(_loc2_ in this.var_245 as Array)
            {
               if(_loc2_)
               {
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         var _loc1_:Array = this.var_245[0] as Array;
      ...
      public function getPalette(param1:int) : Array
      {
         ...
         if(this.var_245.length <= param1)
         {
            return null;
         }
         return this.var_245[param1] as Array;
      }
