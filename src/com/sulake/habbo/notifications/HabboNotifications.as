package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1317:String = "pixelbalance";
      
      private static const const_1318:String = "badges";
      
      private static const const_1319:String = "selectbadge";
      
      private static const const_1316:String = "inventory";
      
      private static const const_1322:String = "selectfurni";
      
      private static const const_1315:String = "credits";
      
      private static const const_1321:String = "friendlist";
      
      private static const const_1320:String = "pet_inventory";
      ...
      private var var_737:IHabboToolbar;
      ...
      private var var_920:ClubEndingNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_919);
         }
         var _loc6_:Map = this.var_919["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_737)
         {
            this.var_737.release(new IIDHabboToolbar());
            this.var_737 = null;
         }
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_919["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
      ...
      {
         this.var_737 = IHabboToolbar(param2);
         this.var_737.events.addEventListener(HabboToolbarEvent.const_65,this.onHabboToolbarEvent);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_65)
         {
            ...
            this.var_491 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_919["styles"],this.var_919["view"],this.var_737);
            ...
            this.var_294.events.addEventListener(BadgeImageReadyEvent.const_129,this.onBadgeImage);
            this.var_737.events.addEventListener(HabboToolbarEvent.const_598,this.onToolbarRepositionEvent);
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1386[_loc2_.badgeID] = new AchievementNotification(_loc2_.badgeID,_loc2_.achievementID,_loc2_.level,_loc2_.points,_loc2_.levelRewardPoints,_loc2_.levelRewardPointType,_loc2_.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_294);
      }
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            this.addItem(_loc4_.value,NotificationType.const_1563,null);
         }
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_294.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1207,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1207,null);
            }
         }
      }
      ...
      private function onBadgeReceived(param1:BadgeReceivedMessageEvent) : void
      {
         ...
         if(this.var_294.userId == _loc3_)
         {
            ...
            this.addItem(!!_loc6_ ? _loc6_.value : "notifications.text.received.badge",NotificationType.const_670,_loc9_,_loc4_);
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1743,null);
         }
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc8_)
            {
               ...
               else if(_loc8_.productType == CatalogPageMessageProductData.const_75)
               {
         ...
         if(_loc7_)
         {
            this.addItem(_loc7_.value,NotificationType.const_1709,_loc5_);
         }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1677,null);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1603)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               this.var_920 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,assets,this._windowManager,this._catalog,this._localization);
            }
      ...
      {
         var _loc2_:* = null;
         if(this.var_491.isSpaceAvailable() && this.var_1133.length > 0)
         {
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            ...
            if(param2 == 4057)
            {
               return FurniCategory.const_416;
            }
            return 1;
         }
         return 1;
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2356)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_670,null);
            this.var_2356 = true;
      ...
      {
         if(param2.type == WindowEvent.const_206 || param2.type == WindowEvent.const_907)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_670,_loc6_);
      }
   }
}
