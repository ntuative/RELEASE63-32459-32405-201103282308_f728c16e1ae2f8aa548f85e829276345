package com.sulake.habbo.ui
{
   ...
   public class FurnitureStickieWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_847,RoomWidgetStickieSendUpdateMessage.const_731,RoomWidgetStickieSendUpdateMessage.const_546];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_847:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc6_ != null)
                  {
                     ...
                     _loc11_ = new RoomWidgetStickieDataUpdateEvent(RoomWidgetStickieDataUpdateEvent.const_848,_loc2_.id,_loc3_.getType(),_loc9_,_loc8_,_loc10_);
