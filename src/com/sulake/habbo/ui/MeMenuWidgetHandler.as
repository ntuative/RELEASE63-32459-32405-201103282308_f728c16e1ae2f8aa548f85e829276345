   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_300,this.onFigureUpdate);
            }
            if(this._inventory != null)
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_655,this.onAvatarEffectsChanged);
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_892,this.onHabboClubSubscriptionChanged);
            }
            if(this.var_180 != null)
            {
               this.var_180.events.removeEventListener(HabboToolbarEvent.const_65,this.onHabboToolbarEvent);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_300,this.onFigureUpdate);
         }
         this._inventory = this._container.inventory;
         if(this._inventory != null)
         {
            this._inventory.events.addEventListener(HabboInventoryEffectsEvent.const_655,this.onAvatarEffectsChanged);
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_892,this.onHabboClubSubscriptionChanged);
         }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc2_ != this.var_1315)
            {
               ...
               this.var_1579 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1579;
            }
         }
         if(this.var_180 != null)
         {
            _loc5_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1102,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null)
            {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetGetEffectsMessage.const_917);
         ...
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_802);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_361);
         _loc1_.push(RoomWidgetStopEffectMessage.const_646);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1675);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1043);
         _loc1_.push(RoomWidgetToolbarMessage.const_898);
         _loc1_.push(RoomWidgetToolbarMessage.const_920);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_351);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1617);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1147);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_832);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_673);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_736);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1480);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_651);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_748);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_879);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_673:
            ...
            case RoomWidgetDanceMessage.const_868:
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_917:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_361:
               ...
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1106)
               {
               ...
               if(this._inventory != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_1228:
                        this._catalog.openCatalogPage(CatalogPageName.const_1737,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1221:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_299);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1510:
            ...
            case RoomWidgetStopEffectMessage.const_646:
            ...
            case RoomWidgetSetToolbarIconMessage.const_1179:
               ...
               {
                  case RoomWidgetSetToolbarIconMessage.const_1539:
                     break;
                  default:
            ...
            case RoomWidgetShowOwnRoomsMessage.const_832:
               ...
               break;
            case RoomWidgetToolbarMessage.const_898:
               ...
               break;
            case RoomWidgetToolbarMessage.const_920:
               ...
               {
                  this.var_180.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_587,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_351:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_462));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_736:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_403,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_651:
               this._container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_403,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_748:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_403,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_879:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_710));
      }
