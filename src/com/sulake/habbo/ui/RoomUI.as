package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1196:IRoomWidgetFactory;
      ...
      private var var_1153:IHabboHelp;
      ...
      {
         this.var_1505 = RoomDesktop.const_501;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1196.release(new IIDHabboRoomWidget());
            this.var_1196 = null;
         }
         ...
         {
            this.var_1153.release(new IIDHabboHelp());
            this.var_1153 = null;
         }
         ...
         {
            this.var_998.release(new IIDHabboModeration());
            this.var_998 = null;
         }
      ...
      private function onRoomWidgetFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1196 = param2 as IRoomWidgetFactory;
      }
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1942 = param2 as IHabboAvatarEditor;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            this.var_314.events.addEventListener(AdEvent.const_530,this.adEventHandler);
            this.var_314.events.addEventListener(AdEvent.const_488,this.adEventHandler);
            this.var_314.events.addEventListener(AdEvent.const_481,this.adEventHandler);
         }
      }
      ...
      private function onHabboHelpReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1153 = param2 as IHabboHelp;
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_998 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_998);
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_15)
         {
            this.var_15.events.addEventListener(RoomSessionEvent.const_245,this.roomSessionStateEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionChatEvent.const_553,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_515,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_565,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_578,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_490,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1256,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_639,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_687,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_192,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_728,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_686,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionQueueEvent.const_482,this.roomSessionEventHandler);
      ...
      private function roomSessionStateEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionEvent.const_245:
            ...
            case RoomSessionEvent.const_92:
               if(param1.session != null)
               {
                  ...
                  this.var_180.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_158,HabboToolbarIconEnum.ZOOM));
                  this.var_180.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_158,HabboToolbarIconEnum.MEMENU));
                  this.var_180.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_158,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      private function initializeRoomEngineEvents() : void
      {
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_900,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_650,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_548,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_558,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineDimmerStateEvent.const_62,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_721,this.roomEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_389,this.roomObjectEventHandler);
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         else if(param1.type == RoomEngineEvent.const_558 || param1.type == RoomEngineEvent.const_548)
         {
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_900:
               _loc5_ = false;
               ...
               if(this.var_1505 != RoomDesktop.const_501)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_290,this.var_1505);
               }
               if(this.var_314 != null)
               {
            ...
            case RoomEngineEvent.const_650:
               ...
               break;
            case RoomEngineRoomColorEvent.const_721:
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.roomWidgetFactory = this.var_1196;
         ...
         _loc3_.avatarEditor = this.var_1942;
         _loc3_.catalog = this._catalog;
         _loc3_.adManager = this.var_314;
         _loc3_.localization = this._localization;
         _loc3_.habboHelp = this.var_1153;
         _loc3_.moderation = this.var_998;
         _loc3_.config = this._config;
         _loc3_.soundManager = this.var_489;
         ...
         _loc3_.createWidget(RoomWidgetEnum.const_844);
         _loc3_.init();
      ...
      public function disposeDesktop(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != RoomDesktop.const_501)
            {
