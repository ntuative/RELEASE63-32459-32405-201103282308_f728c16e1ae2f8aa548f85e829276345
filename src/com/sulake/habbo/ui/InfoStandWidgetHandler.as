package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_590.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_590.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_824);
         _loc1_.push(RoomWidgetGiveBadgeMessage.GIVE_BADGE);
         _loc1_.push(RoomWidgetFurniActionMessage.const_195);
         _loc1_.push(RoomWidgetFurniActionMessage.const_569);
         _loc1_.push(RoomWidgetFurniActionMessage.const_561);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_830);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_669);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_846);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1706);
         _loc1_.push(RoomWidgetPetCommandMessage.const_555);
         _loc1_.push(RoomWidgetPetCommandMessage.const_861);
         _loc1_.push(RoomWidgetUserActionMessage.const_547);
         _loc1_.push(RoomWidgetUserActionMessage.const_356);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_522)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_356 || param1.type == RoomWidgetUserActionMessage.const_547 || param1.type == RoomWidgetUserActionMessage.const_573)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_817:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1156,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_685:
               ...
               break;
            case RoomWidgetUserActionMessage.const_824:
            ...
            case RoomWidgetRoomTagSearchMessage.const_830:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_669:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_846:
            ...
            case RoomWidgetUserActionMessage.const_746:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_861:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_301);
               _loc6_.id = param1.id;
               ...
               if(_loc8_.getString(RoomWidgetEnum.const_529) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetEnum.const_529);
               }
               ...
               {
                  _loc26_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_318);
               ...
               _loc11_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1068);
               _loc12_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1260);
            ...
            case RoomObjectCategoryEnum.const_34:
               ...
               {
                  if(_loc13_.type != RoomObjectTypeEnum.const_783)
                  {
                     return null;
                  }
                  _loc14_ = "null";
               ...
               if(_loc19_ != null)
               {
                  _loc15_.carryItem = _loc19_.getModel().getNumber(RoomObjectVariableEnum.const_534);
               }
               ...
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_135)
               {
                  ...
                  if(_loc19_ != null)
                  {
                     _loc33_ = _loc19_.getModel().getString(RoomObjectVariableEnum.const_724);
                  ...
                  if(!_loc29_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1057;
                  }
                  if(!_loc30_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1262;
                  }
               ...
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc16_.push(RoomWidgetUserInfoUpdateEvent.const_1742);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_590.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_590.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
