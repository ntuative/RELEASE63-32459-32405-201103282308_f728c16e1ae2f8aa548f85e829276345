package com.sulake.habbo.help.help.data
{
   ...
   public class FaqCategory
   {
      ...
      {
         var _loc4_:FaqItem = this.method_1(param1);
         if(_loc4_ == null)
         {
            _loc4_ = new FaqItem(param1,param2,this.var_152.length,this);
      ...
      {
         var _loc3_:FaqItem = this.method_1(param1);
         if(_loc3_ != null)
         {
      ...
      {
         return this.var_152.getValue(param1) != null;
      }
      
      public function method_1(param1:int) : FaqItem
      {
      ...
      {
         var _loc2_:FaqItem = this.method_1(param1);
         if(_loc2_ == null)
         {
            return -1;
         }
      ...
      {
         return this.var_152.length > 0 || this.hasUpdatedWithinHour();
      }
      
      public function setTimeStamp() : void
      {
         this.var_1658 = new Date();
      }
      ...
      public function getAgeSeconds() : Number
      {
         ...
         return (new Date().valueOf() - this.var_1658.valueOf()) / 1000;
      }
