package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201103282303));
         this.var_180 = param5;
         this.var_119 = new Map();
         this.var_119.add(HabboHelpViewEnum.const_1460,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_119.add(HabboHelpViewEnum.const_207,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_119.add(HabboHelpViewEnum.const_535,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_119.add(HabboHelpViewEnum.const_296,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_119.add(HabboHelpViewEnum.const_275,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_119.add(HabboHelpViewEnum.const_370,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_119.add(HabboHelpViewEnum.const_718,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_119.add(HabboHelpViewEnum.const_278,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_119.add(HabboHelpViewEnum.const_1195,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_119.add(HabboHelpViewEnum.const_1105,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_119.add(HabboHelpViewEnum.const_904,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_521.length == 0 || param1 != this.var_369)
            {
               this.var_521.push(this.var_369);
            }
         }
         this.var_369 = param1;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_278:
               this.showUI(HabboHelpViewEnum.const_278);
               break;
            case CallForHelpResultEnum.const_1198:
               this.showUI(HabboHelpViewEnum.const_1105);
               break;
            case CallForHelpResultEnum.const_1250:
               this.showUI(HabboHelpViewEnum.const_1195);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_119.getValue(HabboHelpViewEnum.const_207) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_471));
      }
      ...
      {
         return this.var_119.getValue(this.var_369);
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_521.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_369 == HabboHelpViewEnum.const_207)
         {
            return;
         }
         if(this.var_636.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_636.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_636[1],this.var_636[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_636[0],this.var_636[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_369 == HabboHelpViewEnum.const_207 || this.var_521.length == 0)
         {
            return;
         }
         if(this.var_370 == null)
