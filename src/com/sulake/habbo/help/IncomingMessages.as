package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      {
         this.var_22.showUI(HabboHelpViewEnum.const_370);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         this.var_22.showUI(HabboHelpViewEnum.const_535);
      }
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FaqItem = _loc3_.method_1(_loc2_.questionId);
         if(_loc4_ != null)
         {
            this.var_22.tellUI(HabboHelpViewEnum.const_275,_loc4_);
         }
      }
