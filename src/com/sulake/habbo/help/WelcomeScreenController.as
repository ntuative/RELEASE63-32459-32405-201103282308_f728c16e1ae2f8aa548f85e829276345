package com.sulake.habbo.help
{
   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      {
         return this._notifications[this.var_1441];
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_132)
         {
            this.var_132.toolbar.events.removeEventListener(HabboToolbarEvent.const_37,this.onToolbarClicked);
            this.var_132.toolbar.events.removeEventListener(HabboToolbarEvent.const_807,this.onToolbarResized);
            this.var_132 = null;
         }
         ...
         {
            this.var_770.stop();
            this.var_770.removeEventListener(TimerEvent.TIMER,this.onReminderTimer);
            this.var_770 = null;
         }
      ...
      public function showWelcomeScreen(param1:Boolean) : void
      {
         ...
         this.var_132.toolbar.events.addEventListener(HabboToolbarEvent.const_37,this.onToolbarClicked);
         this.var_132.toolbar.events.addEventListener(HabboToolbarEvent.const_807,this.onToolbarResized);
         var _loc4_:int = parseInt(this._config.getKey("welcome.screen.delay","5000"));
         this.var_770 = new Timer(_loc4_);
      ...
      public function onReminderTimer(param1:TimerEvent) : void
      {
         ...
         this.var_339.y = this.var_132.toolbar.getIconLocation(this.current.targetIconId) - this._window.height / 2;
         this._window.y = this.var_339.y;
      ...
      private function closeWindow() : void
      {
         ...
         if(this.var_1441 < this._notifications.length - 1)
         {
            ++this.var_1441;
         }
         else
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:Number = Point.distance(this._window.rectangle.topLeft,this.var_339);
         if(_loc2_ > 5)
         {
            _loc3_ = Point.interpolate(this._window.rectangle.topLeft,this.var_339,0.5);
            this._window.x = _loc3_.x;
            this._window.y = _loc3_.y;
         }
         else
         {
            this._window.x = this.var_339.x;
            this._window.y = this.var_339.y;
            this.var_132.removeUpdateReceiver(this);
         }
      }
