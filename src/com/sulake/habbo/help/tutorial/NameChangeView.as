package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1400:uint = 13232628;
      ...
      private var var_1141:NameSuggestionListRenderer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1744 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_747)
         {
            this.var_747 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_747)
            {
               return;
            }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            case ChangeUserNameResultMessageEvent.var_843:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1042 || param1 == ChangeUserNameResultMessageEvent.var_1041)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1141 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1141.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1400;
