package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_555:IScrollbarWindow;
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_555 = IScrollbarWindow(this.var_182.findChildByName("scroller"));
      }
      ...
      private function onRow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(this.var_552.visible && this.var_2824)
            {
               return;
            }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2823 - _loc2_.stageX);
         this.var_2823 = _loc2_.stageX;
         this.var_2824 = _loc3_ > 2;
      }
   }
}
