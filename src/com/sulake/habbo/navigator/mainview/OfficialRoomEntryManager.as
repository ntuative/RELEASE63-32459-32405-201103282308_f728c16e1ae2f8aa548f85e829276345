package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomEntryManager implements IDisposable
   {
      ...
      private static const const_1366:int = 267;
      
      private static const const_1364:int = 65;
      
      private static const const_1365:int = -70;
      ...
      private var var_2607:PublicRoomThumbs;
      
      public function OfficialRoomEntryManager(param1:HabboNavigator)
      {
         this.var_2607 = new PublicRoomThumbs();
         super();
      ...
      private function refreshUserCount(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param2.showDetails && (param2.type == OfficialRoomEntryData.const_839 || param2.type == OfficialRoomEntryData.const_681))
         {
            _loc3_ = 3;
            _loc4_ = 34;
            _loc5_ = 13;
      ...
      private function refreshCell(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         _loc3_.visible = true;
         _loc3_.width = !!param2.showDetails ? int(const_1364) : int(const_1366);
      ...
      {
         var _loc4_:String = this.var_2607.resolveRoomImageName(param2);
         ...
         param3.x = !!param2.showDetails ? int(const_1365) : 0;
      ...
      private function handleClick(param1:IWindow) : void
      {
         ...
         else if(_loc2_.tag != null)
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_225,Tabs.const_366,_loc2_.tag);
         }
