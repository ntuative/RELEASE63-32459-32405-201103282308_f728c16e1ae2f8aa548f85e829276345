package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_623 = new Timer(100);
         this.var_623.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
      ...
      public function dispose() : void
      {
         if(this.var_623)
         {
            this.var_623.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_623.reset();
            this.var_623 = null;
         }
      }
      ...
      private function updateArrowPos(param1:Event) : void
      {
         ...
         _loc3_.y += !!this.var_1807 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1807 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_60 = IItemListWindow(this.var_182.findChildByName("item_list"));
         ...
         this.var_1167 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_182.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_73,HabboWindowStyle.const_32,HabboWindowParam.const_61,new Rectangle(0,0,100,300)));
      }
