package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_662:RoomInfoViewCtrl;
      
      private var var_1240:RoomCreateViewCtrl;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_662 = new RoomInfoViewCtrl(this);
         this.var_1240 = new RoomCreateViewCtrl(this);
         this.var_2559 = new RoomThumbnailRenderer(this);
         this.var_980 = new GuestRoomPasswordInput(this);
         this.var_293 = new GuestRoomDoorbell(this);
         this.var_434 = new Tabs(this);
         this.var_1239 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_316,HabboWindowStyle.const_43,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1424 = new IncomingMessages(this);
      }
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_662.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_180.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_151,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this.var_180.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_151,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_316.startSearch(Tabs.const_225,Tabs.const_366,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_316.startSearch(Tabs.const_283,Tabs.const_242);
         this.var_434.getTab(Tabs.const_283).tabPageDecorator.tabSelected();
      }
