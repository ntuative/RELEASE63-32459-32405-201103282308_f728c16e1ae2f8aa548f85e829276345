package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2559 = new RoomThumbnailRenderer(param1);
         this.var_1269 = new TagRenderer(param1,hideInstantly);
      }
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         this.refreshRoomName(this.var_185,this.var_117);
         if(this.var_117.ownerName != "" && this.var_117.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_185,!!this.var_117.event ? this.getEventCtg(this.var_117.categoryId) : this.getRoomCtg(this.var_117.categoryId));
         this.refreshRoomDesc(this.var_185,this.var_117);
         this.refreshExtraCont();
         this.refreshInfo(this.var_185,"trading_allowed",this.var_117.allowTrading);
         this.refreshInfo(this.var_185,"doormode_doorbell",this.var_117.doorMode == 1);
         this.refreshInfo(this.var_185,"doormode_password",this.var_117.doorMode == 2);
      ...
      {
         this.refreshTextWithCaption("roomowner",this.var_185,this.var_117.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_1269.refreshTags(_loc1_,this.var_117.tags);
         ...
         this.var_2559.refreshThumbnail(_loc1_,this.var_117.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_225,Tabs.const_221,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
