package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1806 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1165 = this.var_1806.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1165)
         {
            this.var_1165.procedure = this.onButtonClick;
         }
         this.var_1164 = this.var_1806.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1164)
         {
            this.var_1164.procedure = this.onButtonClick;
         }
      ...
      private function checkButtons() : void
      {
         ...
         {
            this.var_1164.disable();
         }
         else
         {
            this.var_1164.enable();
         }
         if(this.var_258 <= 0)
         {
            this.var_1165.disable();
         }
         else
         {
            this.var_1165.enable();
         }
      }
