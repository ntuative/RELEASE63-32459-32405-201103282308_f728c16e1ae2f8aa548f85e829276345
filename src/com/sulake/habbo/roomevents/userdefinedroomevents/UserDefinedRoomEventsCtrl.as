package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1316:int = 2;
      ...
      private var var_1582:TriggerConfs;
      
      private var var_1581:ActionTypes;
      
      private var var_1580:ConditionTypes;
      
      private var var_240:Dictionary;
      
      private var var_36:Triggerable;
      
      private var var_695:RoomObjectHightLighter;
      ...
      {
         this.var_1582 = new TriggerConfs();
         this.var_1581 = new ActionTypes();
         this.var_1580 = new ConditionTypes();
         this.var_240 = new Dictionary();
         super();
         this.var_80 = param1;
         this.var_695 = new RoomObjectHightLighter(param1);
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1057 = new SliderWindowController(this.var_80,IWindowContainer(this.find(this.var_50,"delay_slider_container")),this.var_80.assets,0,20,1);
         this.var_1057.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1057.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_695.hideAll(this.var_240);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_695.showAll(this.var_240);
         if(this.var_36 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_36);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1057.setValue(_loc6_);
         }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1057.getValue()) : 0;
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = this.var_36.stuffTypeSelectionCode < 1 ? int(var_1316) : int(this.var_36.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = (this.var_36.stuffTypeSelectionCode + 1) % (var_1316 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1582);
         this.refreshConfigureElement(this.var_1581);
         this.refreshConfigureElement(this.var_1580);
