package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1111,param1);
         this.var_902 = param1;
         if(param2)
         {
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_903)
         {
            if(param1.type == WindowMouseEvent.const_59 || param1.type == WindowMouseEvent.const_191)
            {
               this.var_903 = false;
            }
         }
         if(!this.var_903 || param1.type != WindowEvent.const_378)
         {
            return;
         }
         if(this.var_591 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_591) * this.var_591;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_591 != 0)
            {
               _loc3_ = this.var_902 + this.var_591;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc2_ != null && this.var_727 != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_727.width,this.var_727.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_727,this.var_727.rect,new Point(0,0),null,null,true);
         }
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && this.var_726 != null)
            {
               ...
               this.var_1684 = _loc1_.width - _loc2_.width;
            }
         }
