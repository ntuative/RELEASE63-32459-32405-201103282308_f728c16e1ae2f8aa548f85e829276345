package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_816:String = "RCL_LOADER_READY";
      
      private static const const_340:String = "RCL_PUBLICROOM_";
      
      private static const const_1785:int = 0;
      
      private static const const_957:int = 1;
      
      private static const name_3:int = 2;
      
      private static const const_426:String = "place_holder";
      
      private static const const_613:String = "wall_place_holder";
      
      private static const const_614:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_426;
      
      private static const const_615:String = "room";
      
      private static const TILE_CURSOR:String = "tile_cursor";
      
      private static const const_958:String = "selection_arrow";
      ...
      public function RoomContentLoader()
      {
         ...
         this.var_2412 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
      ...
      {
         if(this._state >= const_957)
         {
            return;
         }
         this._stateEvents = param1;
         this.var_2413 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2410 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2409 = param2.getKey("public.room.dynamic.download.url","");
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_496.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.var_496.getWithIndex(_loc3_) as AssetLibrary;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
         ...
         {
            _loc2_ = this.var_423.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc5_ = this.var_423.getWithIndex(_loc3_) as IGraphicAssetCollection;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               this.var_745.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_422.add(_loc3_,_loc4_);
      ...
      private function continueInitilization() : void
      {
         if(this.var_2411)
         {
            ...
            {
               this._stateEvents.dispatchEvent(new Event(const_816));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         ...
         if(this.var_494 != null)
         {
            this.var_494.remove(param2);
            this.var_494.add(param2,param1);
         }
      }
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         {
            return RoomObjectCategoryEnum.const_320;
         }
         return RoomObjectCategoryEnum.const_169;
      }
      ...
      {
         return [const_426,const_613,const_614,const_615,TILE_CURSOR,const_958];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_422.getValue(param1) as String;
      ...
      {
         return this.var_926.getValue(param1) as String;
      }
      
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         var _loc3_:Map = this.var_927[param1];
         if(_loc3_ != null)
         {
      ...
      {
         if(this.var_745.getValue(param1) != null)
         {
            return this.var_745.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_202 != null && this.var_202.hasWorldType(const_340 + param1))
         {
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_232 || param1 == RoomObjectVisualizationEnum.const_64 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               while(_loc9_ < _loc7_.length)
               {
                  ...
                  _loc8_.push(this.var_2409 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            this.var_202 = this.var_1398.getValue(param1) as PublicRoomData;
         }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2412.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            ...
            else if(this.var_421[_loc5_] != null)
            {
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc6_ = this.var_421[param1];
            this.var_927.add(_loc6_,_loc3_);
         }
      }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1398.add(param1,_loc4_);
         this.var_202 = _loc4_;
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_746.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_746.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_496.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = this.var_746.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = this.getContentType(_loc4_);
               _loc3_ = this.var_496.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_496.add(_loc5_,_loc4_);
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         if(_loc3_ != null)
         {
            ...
            this.var_423.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:String = this.getContentType(param1);
         return this.var_423.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      private function disposeGraphicAssetCollection(param1:String) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:String = this.getContentType(param1);
         if(this.var_423[_loc2_] != null)
         {
            _loc3_ = this.var_423.remove(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         {
            _loc6_ = _loc3_[_loc5_];
            _loc7_ = const_340 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(this.getObjectCategory(const_340 + param1) == RoomObjectCategoryEnum.const_74)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_202.getWorldHeightScale(const_340 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_202 != null)
         {
            return this.var_202.getWorldScale(const_340 + param1);
         }
         return 32;
      }
      ...
      {
         this.var_422.remove(param1);
         this.var_422.add(param1,param2);
      }
   }
}
