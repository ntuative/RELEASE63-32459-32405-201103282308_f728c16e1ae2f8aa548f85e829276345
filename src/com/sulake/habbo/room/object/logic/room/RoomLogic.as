package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1840:int = 255;
      
      private var var_1185:uint = 16777215;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_446,RoomObjectMouseEvent.const_153];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_801,16777215);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1184)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1841;
            if(_loc2_ - this.var_1184 >= this.var_1838)
            {
               _loc3_ = this.var_1185;
            ...
            else
            {
               ...
               _loc10_ = this.var_1185 >> 16 & 255;
               _loc11_ = this.var_1185 >> 8 & 255;
               _loc12_ = this.var_1185 & 255;
               _loc13_ = (_loc2_ - this.var_1184) / this.var_1838;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1840 + (this.var_1839 - this.var_1840) * _loc13_;
               this._color = _loc3_;
               this.var_1841 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_801,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            ...
            case RoomObjectRoomUpdateMessage.const_716:
               param2.setString(RoomObjectVariableEnum.const_749,param1.value);
               break;
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_549:
               _loc5_ = "null";
               ...
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_791:
               _loc4_ = this.var_492.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_492.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1153,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1230:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         this.var_1840 = this.var_1841;
         this.var_1185 = _loc3_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_459,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1471,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1573,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1692,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_459,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_167 || _loc12_ == RoomPlaneData.const_308)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
