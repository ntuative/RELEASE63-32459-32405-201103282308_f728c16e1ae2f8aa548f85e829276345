package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private var var_2256:Number = NaN;
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(param4)
         {
            this.var_1361 |= this.updateAnimation(_loc6_);
         }
         else
         {
            _loc7_ = this.updateAnimation(_loc6_) | this.var_1361;
            this.var_1361 = 0;
         }
         if(_loc5_ || _loc7_ != 0)
         {
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:int) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(this.var_635 != spriteCount)
         {
            createSprites(this.var_635);
         }
         if(param2)
         {
      ...
      private function updateSprite(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null && _loc3_ != null)
         {
            ...
            if(_loc5_ != null && _loc5_.asset != null)
            {
               ...
               _loc4_.clickHandling = this.var_2257;
            }
            else
            {
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_469 != _loc3_.getUpdateID() || param1 != var_103 || param2 != this.var_2256)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2258 = _loc3_.getNumber(RoomObjectVariableEnum.const_277);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_336));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            this.var_1098 = _loc3_.getString(RoomObjectVariableEnum.const_365);
            if(this.var_1098 == null || this.var_1098.indexOf("http") != 0)
            {
               this.var_1098 = null;
            }
            this.var_2257 = this.var_1098 != null;
      ...
      {
         if(this.var_2255 != param2 || this.var_2253 != param1)
         {
            this.var_895 = [];
            this.var_894 = [];
            this.var_714 = [];
            ...
            this.var_2254 = this.getSize(param1);
      ...
      {
         this.var_635 = param1;
         this.var_1666 = this.var_635 - this.getAdditionalSpriteCount();
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         var _loc3_:String = this.var_895[param2];
         var _loc4_:Boolean = this.var_894[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            _loc5_ = this.var_2254;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1666)
            {
            ...
            this.var_895[param2] = _loc3_;
            this.var_894[param2] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      {
         if(this.var_717[param3] != null && !this.var_1667)
         {
