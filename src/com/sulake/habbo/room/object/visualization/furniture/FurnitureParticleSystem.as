package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystem
   {
      ...
      private var var_1515:ColorTransform;
      
      private var var_1971:Matrix;
      
      private var _translationMatrix:Matrix;
      
      private var var_822:Number = 1.0;
      ...
      public function FurnitureParticleSystem(param1:AnimatedFurnitureVisualization)
      {
         ...
         this.var_1515 = new ColorTransform();
         this.var_1971 = new Matrix();
      ...
      public function setAnimation(param1:int) : void
      {
         ...
         this.var_100 = this.var_1258[param1];
         this.var_1017 = false;
         this.updateCanvas();
      }
      ...
      private function updateCanvas() : void
      {
         ...
         if(this.var_1970 >= 0)
         {
            this.var_268 = this._visualization.getSprite(this.var_1970);
            if(this.var_268 && this.var_268.asset)
            {
               ...
               if(this.var_87 == null)
               {
                  ...
                  if(this.var_820.alphaMultiplier != 1)
                  {
                     this.var_668 = new BitmapData(this.var_87.width,this.var_87.height,true,4278190080);
                  }
               }
               this.var_2261 = -this.var_268.offsetX;
               this.var_2260 = -this.var_268.offsetY;
            ...
            if(this.var_668)
            {
               this.var_668.fillRect(this.var_668.rect,4278190080);
            }
         }
      }
      ...
      public function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            return this.var_100.y * this.var_1259;
         }
         return 0;
      }
      ...
      public function updateAnimation() : void
      {
         ...
         _loc8_ = this.var_1157 * this.var_1259;
         this.var_100.update();
         if(this.var_1017)
         {
            if(this.var_100.roomObjectSpriteId >= 0)
            ...
            {
               this.var_87.draw(this.var_668,this.var_1971,this.var_820,BlendMode.NORMAL,null,false);
            }
            for each(_loc11_ in this.var_100.particles)
            {
               _loc2_ = Number(_loc11_.y);
               _loc3_ = this.var_2261 + (_loc11_.x - _loc11_.z) * 10 / 10 * this.var_1259;
               _loc4_ = this.var_2260 - _loc8_ + (_loc2_ + (_loc11_.x + _loc11_.z) / 2) * 10 / 10 * this.var_1259;
               ...
               if(_loc6_)
               {
                  ...
                  if(_loc11_.fade && _loc11_.alphaMultiplier < 1)
                  {
                     ...
                     this.var_1515.alphaMultiplier = _loc11_.alphaMultiplier;
                     this.var_87.draw(_loc7_,this._translationMatrix,this.var_1515,BlendMode.NORMAL,null,false);
                  }
                  else
                  {
      ...
      public function parseData(param1:XML) : void
      {
         ...
         var _loc23_:* = null;
         var _loc24_:* = null;
         this.var_2741 = parseInt(param1.@size);
         this.var_1970 = !!param1.hasOwnProperty("@canvas_id") ? int(parseInt(param1.@canvas_id)) : -1;
         this.var_1157 = !!param1.hasOwnProperty("@offset_y") ? int(parseInt(param1.@offset_y)) : 10;
         this.var_1259 = this.var_2741 / 64;
         this.var_822 = !!param1.hasOwnProperty("@blend") ? Number(Number(param1.@blend)) : Number(1);
         this.var_822 = Math.min(this.var_822,1);
         this.var_820.alphaMultiplier = this.var_822;
