package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1270:String = "shore";
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc1_ in this.var_1056)
            {
      ...
      {
         if(this.var_2104 == param1 && this.var_2105 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1270)
            {
               this.var_1574 = _loc2_;
               this.var_2104 = param1;
               this.var_2105 = direction;
               return this.var_1574;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1056.indexOf(_loc2_) < 0)
            {
      ...
      private function updateBorderData() : void
      {
         ...
         var _loc3_:int = this.var_470 + 2;
         var _loc4_:int = this.var_564 + 2;
         var _loc5_:int = 0;
         ...
         this.var_1575 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_402.length)
         {
            if(this.var_402[_loc5_] == true)
            {
               this.var_1575 = true;
            }
            _loc5_++;
      ...
      {
         var _loc2_:* = null;
         if(this.var_470 == 0 || this.var_564 == 0)
         {
            ...
            this.var_470 = _loc2_.getNumber(RoomObjectVariableEnum.const_321);
            this.var_564 = _loc2_.getNumber(RoomObjectVariableEnum.const_398);
         }
         this.var_402 = [];
         this.var_565 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_470 * 2 + this.var_564 * 2)
         {
            this.var_402.push(false);
            this.var_565.push(ShoreMaskCreatorUtility.const_77);
            _loc1_++;
         }
      }
      ...
      {
         var _loc1_:int = this.var_470 + 2;
         var _loc2_:int = this.var_564 + 2;
         var _loc3_:* = [];
         var _loc4_:* = null;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_70,getSize(param3),this.var_402,this.var_565,assetCollection);
      }
