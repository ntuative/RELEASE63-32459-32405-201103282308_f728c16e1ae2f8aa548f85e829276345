package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlane
   {
      ...
      public function FurniturePlane(param1:IVector3d, param2:IVector3d, param3:IVector3d)
      {
         ...
         this.var_778 = new Vector3d();
         this.var_778.assign(param3);
      ...
      {
         if(param1 != this.var_2591)
         {
            if(!param1)
            {
               this.var_303.assign(this.var_777);
               this.var_302.assign(this.var_778);
            }
            else
            {
               this.var_303.assign(this.var_777);
               this.var_303.mul(this.var_778.length / this.var_777.length);
               this.var_302.assign(this.var_778);
               this.var_302.mul(this.var_777.length / this.var_778.length);
            }
            this.var_1801 = -1;
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || this.var_91 == null && this.var_1094 != null || this.var_303 == null || this.var_302 == null || this.var_583 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != this.var_1801)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != this.var_1459 || _loc4_.y != this.var_2361 || _loc4_.z != this.var_2364 || param1.scale != this.var_2357))
            {
               this.var_1459 = _loc4_.x;
               this.var_2361 = _loc4_.y;
               this.var_2364 = _loc4_.z;
               ...
               _loc6_ = param1.getScreenPosition(this.var_1094);
               _loc7_ = _loc6_.z;
               _loc8_ = Math.max(this.var_153.z - _loc7_,this.var_113.z - _loc7_,this.var_85.z - _loc7_,this.var_114.z - _loc7_);
               this.var_2229 = _loc8_;
