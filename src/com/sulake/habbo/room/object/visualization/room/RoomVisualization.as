package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1517:int = 16777215;
      ...
      public static const const_1569:int = 16777215;
      
      public static const const_1538:int = 13421772;
      
      public static const const_1519:int = 10066329;
      ...
      private var var_1723:String = null;
      
      private var _floorType:String = null;
      
      private var var_1725:String = null;
      
      private var var_2358:String = null;
      
      private var var_1134:uint = 16777215;
      
      private var var_2360:int = 255;
      ...
      private var var_1966:int = -1000;
      
      private const const_2068:int = 250;
      ...
      private var var_2364:Number = 0.0;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1255);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_217,true,_loc11_,_loc6_);
               if(_loc14_.z != 0)
               {
                  _loc13_.color = const_1517;
               }
               else
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_308)
            {
               ...
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1569;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1538;
               }
               else
               {
                  _loc13_.color = const_1519;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1659)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_122,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
            ...
            if(_loc13_ != null)
            {
               ...
               while(_loc15_ < this._planeParser.getPlaneMaskCount(_loc7_))
               {
                  ...
                  _loc19_ = this._planeParser.method_7(_loc7_,_loc15_);
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         _loc9_ = param2;
         if(_loc9_ < this.var_1966 + this.const_2068 && !_loc6_ && !_loc8_)
         {
            return;
         }
            ...
            while(_loc10_ < this.var_354.length)
            {
               ...
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1719)
                  {
                     ...
                     _loc15_ = uint((_loc14_ & 255) * this.var_2359 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2363 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2360 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1801)
         {
            this.var_1801 = param1.updateId;
            this.var_738 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1459 || _loc3_.y != this.var_2361 || _loc3_.z != this.var_2364 || param1.scale != this.var_2357))
            {
               this.var_1459 = _loc3_.x;
               this.var_2361 = _loc3_.y;
               this.var_2364 = _loc3_.z;
               this.var_2357 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1153);
            if(_loc3_ != this.var_2358)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2358 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_801));
            if(_loc4_ != this.var_1134)
            {
               this.var_1134 = _loc4_;
               this.var_2359 = this.var_1134 & 255;
               this.var_2363 = this.var_1134 >> 8 & 255;
               this.var_2360 = this.var_1134 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1051));
            if(_loc5_ != this.var_1719)
            {
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_176 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_749);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_785);
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < this.var_134.length)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_217 && param1 != null)
               {
                  _loc5_.id = param1;
               }
               ...
               if(_loc12_ != null)
               {
                  if(_loc12_.update(param1,_loc5_))
                  {
                     if(_loc12_.visible)
                     {
                        ...
                        if(_loc12_.type != RoomPlane.const_217)
                        {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1718;
      }
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_122 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_260)
                              {
