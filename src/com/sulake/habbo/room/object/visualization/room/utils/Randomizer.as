package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1969:int = 1;
      
      public static const const_1903:int = 16777216;
      ...
      private var var_1849:int = 16777216;
      ...
      {
         var _loc1_:int = this.var_2890 * this.var_1850 + this.var_2891;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1849;
         this.var_1850 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1849 * param2);
      }
   }
}
