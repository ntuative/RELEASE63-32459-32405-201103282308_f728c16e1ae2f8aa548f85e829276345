package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization implements IPetImageListener
   {
      ...
      private const const_1310:int = 3;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         this.var_338 = new ExperienceData(_loc2_.clone());
         return true;
      }
      ...
      private function updateModel(param1:IRoomObjectModel, param2:Number) : Boolean
      {
         ...
         {
            this.var_1771 = param1.getNumber(RoomObjectVariableEnum.const_418) > 0;
            this.var_1380 = param1.getString(RoomObjectVariableEnum.const_128);
            this.var_255 = param1.getString(RoomObjectVariableEnum.const_235);
            this._postureParameter = param1.getString(RoomObjectVariableEnum.const_719);
            this.var_1704 = param1.getNumber(RoomObjectVariableEnum.const_194);
            this.var_1332 = param1.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2152 = param1.getNumber(RoomObjectVariableEnum.const_889);
      ...
      private function updateObject(param1:IRoomObject, param2:IRoomGeometry, param3:Boolean = false) : Boolean
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param3 || var_469 != param1.getUpdateID() || this.var_1801 != param2.updateId)
         {
            _loc4_ = param1.getDirection().x - param2.direction.x;
            _loc4_ = (_loc4_ % 360 + 360) % 360;
            _loc5_ = this.var_1704;
            if(isNaN(this.var_1704))
            {
               _loc5_ = _loc4_;
            }
            else
            ...
            if(_loc4_ != this.var_1770 || param3)
            {
               this.var_1770 = _loc4_;
               _loc4_ -= 112.5;
               _loc4_ = (_loc4_ + 360) % 360;
               this.var_59.setDirectionAngle(AvatarSetType.const_36,_loc4_);
            }
            if(_loc5_ != this.var_1769 || param3)
            {
      ...
      private function getAvatarImage(param1:Number) : IAvatarImage
      {
         ...
         if(_loc3_ == null)
         {
            _loc3_ = this.var_614.getAvatar(this.var_618,param1,this);
            if(_loc3_ != null)
            {
      ...
      private function updateShadow(param1:Number) : void
      {
         ...
         this.var_616 = null;
         _loc2_ = getSprite(this.const_1776);
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(param1 < 48)
         {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc10_ || _loc7_ != var_103 || this.var_59 == null)
         {
            if(_loc7_ != var_103)
            {
               var_103 = _loc7_;
         ...
         var _loc12_:Boolean = this.var_975 || this.var_1128 > 0 || this.var_1705;
         this.var_338.alpha = 0;
         if(this.var_1332 > 0)
         {
            _loc13_ = param2 - this.var_1332;
            if(_loc13_ < AvatarAction.const_940)
            {
               this.var_338.alpha = int(Math.sin(_loc13_ / 0 * 0) * 255);
               this.var_338.setExperience(this.var_2152);
               this.var_1128 = this.const_2065;
            }
            else
            {
               this.var_1332 = 0;
            }
            _loc14_ = getSprite(this.const_1788);
            if(_loc14_ != null)
            {
               if(this.var_338.alpha > 0)
               {
                  _loc14_.asset = this.var_338.image;
                  _loc14_.offsetX = -20;
                  _loc14_.offsetY = -80;
                  _loc14_.alpha = this.var_338.alpha;
         ...
         if(_loc11_ || _loc12_)
         {
            ...
            _loc14_ = getSprite(this.const_967);
            if(_loc14_)
            {
      ...
      private function updateActions(param1:IAvatarImage) : void
      {
         ...
         {
            param1.appendAction(AvatarAction.const_288,this.var_1380);
         }
         ...
         var _loc2_:int = param1.getSprites().length + this.const_1310;
