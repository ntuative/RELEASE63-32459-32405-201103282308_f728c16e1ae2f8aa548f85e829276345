package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1283:String = "head";
      
      private static const const_604:int = 1;
      
      private static const const_940:int = 1000;
      
      private static const const_1284:String = "pet_experience_bubble_png";
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1284) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_338 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2154)
            {
               this.var_2154 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_235);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_128);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_235);
            if(!isNaN(_loc6_))
            {
            ...
            this.var_1771 = _loc3_.getNumber(RoomObjectVariableEnum.const_418) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_194);
            if(!isNaN(_loc8_))
            {
               this.var_1605 = _loc8_;
            }
            else
            {
               this.var_1605 = direction;
            }
            this.var_1332 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2152 = _loc3_.getNumber(RoomObjectVariableEnum.const_889);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_878);
            if(_loc9_ != this.var_1606)
            {
               this.var_1606 = _loc9_;
               this.var_2153 = this.var_1606.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_338 != null)
         {
            ...
            if(this.var_1332 > 0)
            {
               _loc2_ = param1 - this.var_1332;
               if(_loc2_ < const_940)
               {
                  this.var_338.alpha = int(Math.sin(_loc2_ / const_940 * 0) * 255);
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_338.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_338.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      private function validateActions(param1:String, param2:String) : void
      {
         ...
         if(param1 != this.var_255)
         {
            ...
            this.setAnimationForIndex(const_1282,_loc3_);
         }
         if(param2 != this.var_1380)
         {
            this.var_1380 = param2;
            _loc3_ = this._animationData.getAnimationForGesture(var_103,param2);
            this.setAnimationForIndex(const_1281,_loc3_);
         }
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            _loc2_ = assetCollection.getAssetWithPalette(param1,this.var_2153);
            if(_loc2_ == null)
            {
            }
            return _loc2_;
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_1605);
         }
         return direction;
      }
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_103,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1283)
            {
               this.var_870[param1] = true;
            }
            else
            {
               this.var_870[param1] = false;
            }
         }
