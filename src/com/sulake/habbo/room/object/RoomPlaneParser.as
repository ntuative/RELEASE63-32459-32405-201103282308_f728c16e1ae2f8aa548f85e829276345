package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private var var_135:Number = 0.0;
      ...
      public function initializeTileMap(param1:int, param2:int) : Boolean
      {
         ...
         this.var_253 = param1;
         this._height = param2;
         this.var_519 = this.var_253;
         this.var_518 = -1;
         this.var_516 = this._height;
         this.var_517 = -1;
         return true;
      }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < this.var_253 && param2 >= 0 && param2 < this._height)
         {
            ...
            {
               if(param1 == this.var_519 || param1 == this.var_518)
               {
                  _loc5_ = false;
                  _loc6_ = this.var_516;
               ...
               if(param2 == this.var_516 || param2 == this.var_517)
               {
                  _loc7_ = false;
                  _loc8_ = this.var_519;
                  while(_loc8_ < this.var_518)
                  {
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         this.var_970 = getFloorHeight(this.var_164);
         if(!param1)
         {
      ...
      private function addWall(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Boolean, param6:Boolean, param7:Boolean) : void
      {
         ...
         if(param5)
         {
            this.addPlane(RoomPlaneData.const_167,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + this.var_135) / param3.length),_loc10_,[_loc9_,param4]);
         }
         if(param6)
         {
            this.addPlane(RoomPlaneData.const_167,Vector3d.sum(param1,Vector3d.product(param3,-this.var_135 / param3.length)),Vector3d.product(param3,(param3.length + this.var_135) / param3.length),_loc10_,[_loc9_,param4]);
            if(param7)
            {
      ...
      private function addFloor(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Number, param9:Number, param10:Number, param11:Number) : void
      {
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_177,_loc13_,new Vector3d(0,0,-this.var_135),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
                     _loc14_.addMask(0,0,this.var_135,param8);
                  }
                  if(param9 > 0)
                  {
                     _loc14_.addMask(0,param2.length - param9,this.var_135,param9);
                  }
               }
            }
            if(param7)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_177,_loc13_,new Vector3d(0,0,-this.var_135),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
                     _loc14_.addMask(0,0,this.var_135,param9);
                  }
                  if(param8 > 0)
                  {
                     _loc14_.addMask(0,param2.length - param8,this.var_135,param8);
                  }
               }
            }
            if(param4)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_177,_loc13_,new Vector3d(0,0,-this.var_135),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
                     _loc15_.addMask(0,0,this.var_135,param11);
                  }
                  if(param10 > 0)
                  {
                     _loc15_.addMask(0,param3.length - param10,this.var_135,param10);
                  }
               }
            }
            if(param5)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_177,_loc13_,new Vector3d(0,0,-this.var_135),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
                     _loc15_.addMask(0,0,this.var_135,param10);
                  }
                  if(param11 > 0)
                  {
                     _loc15_.addMask(0,param3.length - param11,this.var_135,param11);
                  }
               }
            }
         }
            ...
            if(_loc6_ != null && _loc7_ != null && _loc8_ != null)
            {
               ...
               if(this.getPlaneMaskCount(_loc2_) > 0)
               {
                  ...
                  while(_loc13_ < this.getPlaneMaskCount(_loc2_))
                  {
                     ...
                     _loc17_ = this.method_7(_loc2_,_loc13_);
      ...
      public function method_7(param1:int, param2:int) : Number
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return -1;
