package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_1569:Boolean;
      
      protected var var_2094:Boolean;
      
      protected var var_2865:BitmapData;
      
      private const const_2077:int = 8947848;
      
      private const const_2076:int = 13421772;
      
      private const const_1805:Number = 1;
      
      private const const_1806:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this._type = param1;
         this._window = param4;
         this.var_1486 = this._window.findChildByTag("BG_COLOR");
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1532));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2080);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_714)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function method_1(param1:int) : IItem
      {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1806;
               _loc1_.blend = this.const_1806;
            }
            else
            {
               this._window.blend = this.const_1805;
               _loc1_.blend = this.const_1805;
            }
         }
         if(this.isSelected)
         {
            this.var_1486.color = this.const_2077;
         }
         else
         {
            this.var_1486.color = this.const_2076;
         }
         ...
         if(_loc5_)
         {
            if(this.var_2094 && this.getRecyclableCount() > 0)
            {
