package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_362:String = "pets";
      ...
      private var var_1833:Vector.<Array>;
      
      private var var_1834:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_489 = param8;
         this.var_630 = new Timer(const_1354,1);
         this.var_630.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2577 = XML(_loc10_.content);
         this.clearFurniList();
         this._view = new FurniView(this,param2,this._windowManager,this._assets,this._roomEngine,this.var_489);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this.var_630.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_630.stop();
               this.var_630 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_46)
            {
               ...
               {
                  this.var_1833 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1833;
            }
            else
            {
               if(this.var_1834 == null)
               {
                  this.var_1834 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1834;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_407)
         {
         ...
         else if(param3 == FurniCategory.const_416)
         {
         ...
         if(this.var_949 == null)
         {
            this.var_949 = this._windowManager.buildFromXML(this.var_2577) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_949.clone() as IWindowContainer;
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_353);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_631.add(const_46,new Array());
         this.var_631.add(const_52,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1) : void
      {
         ...
         if(!param1.groupable)
         {
            for each(_loc7_ in _loc6_)
            {
               ...
               {
                  if(_loc7_.method_1(param1.id) != null)
                  {
                     return;
                  }
                  break;
      ...
      public function updatePostItCount(param1:int, param2:int) : void
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            _loc6_ = _loc5_.method_1(param1) as WallItem;
            if(_loc6_ != null)
            {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_397 || _loc3_.category == FurniCategory.const_407 || _loc3_.category == FurniCategory.const_416)
         {
            if(param1)
            {
               return false;
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc3_:Array = this.var_631.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_714)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
