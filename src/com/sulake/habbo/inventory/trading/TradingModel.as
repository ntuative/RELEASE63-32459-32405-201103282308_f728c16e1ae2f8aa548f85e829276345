package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_186:uint = 0;
      
      public static const const_199:uint = 1;
      
      public static const const_371:uint = 2;
      
      public static const const_302:uint = 3;
      
      public static const const_447:uint = 4;
      
      public static const const_250:uint = 5;
      ...
      public function close() : void
      {
         if(this.var_765)
         {
            if(this._state != const_186 && this._state != const_250)
            {
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_830 + " OTHER: " + this.var_1276);
         ...
         {
            case const_186:
               if(param1 == const_199 || param1 == const_250)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_58.alertPopup(TradingView.const_1096);
         }
         else if(param1 is TradingAcceptEvent)
         {
            ...
            {
               this.var_830 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1276 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_58.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            {
               this.var_58.alertPopup(TradingView.const_1158);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_272.length < const_1491)
         {
