package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_51.getValue(InventoryCategory.const_877));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_51.getValue(InventoryCategory.const_299));
      }
      ...
      public function get achievementsModel() : AchievementsModel
      {
         ...
         return AchievementsModel(this.var_51.getValue(InventoryCategory.const_350));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_51.getValue(InventoryCategory.const_353) as MarketplaceModel;
      }
      ...
      {
         this.var_489 = IHabboSoundManager(param2);
         this.initInventory();
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_294 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this.var_180 || !this.var_489)
         {
            return;
         }
         ...
         this.var_51.add(InventoryCategory.const_353,_loc1_);
         var _loc2_:FurniModel = new FurniModel(this,_loc1_,this._windowManager,this._communication,this._assetLibrary,this._roomEngine,this._catalog,this.var_489);
         ...
         this.var_51.add(InventoryCategory.const_299,_loc3_);
         ...
         this.var_51.add(InventoryCategory.const_877,_loc4_);
         ...
         this.var_51.add(InventoryCategory.const_350,_loc5_);
         var _loc6_:TradingModel = new TradingModel(this,this._windowManager,this._communication,this._assetLibrary,this._roomEngine,this._localization,this.var_489);
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_655));
      }
