package com.sulake.habbo.quest
{
   ...
   public class QuestController implements IDisposable
   {
      ...
      public function questAccepted(param1:String, param2:QuestMessageData) : void
      {
         ...
         if(this.var_133 != null && this.var_133.quest.id == param2.id)
         {
      ...
      public function questCompleted(param1:String, param2:QuestMessageData) : void
      {
         ...
         if(this.var_133 != null && this.var_133.quest.id == param2.id && this.var_96 != null)
         {
      ...
      public function openCampaign(param1:String, param2:int, param3:Array, param4:Boolean) : void
      {
         ...
         if(this.var_596 != MODE_TABS)
         {
            this.var_596 = MODE_NO_TABS;
         }
         this.detachCampaign();
         _loc5_ = this.var_107[param1];
         if(!_loc5_)
      ...
      private function attachCampaign() : void
      {
         ...
         this._selectedCampaign.attachTo(this.var_1189);
      ...
      private function prepareWindow(param1:Boolean) : void
      {
         ...
         this._window.center();
         this.var_1189 = this._window.findChildByName("content") as IWindowContainer;
      }
      ...
      public function initializeReminderTimer() : void
      {
         ...
         this.var_770 = new Timer(_loc1_ * 1000);
         this.var_770.addEventListener(TimerEvent.TIMER,this.onReminderTimer);
      ...
      private function hasBlockingWindow() : Boolean
      {
         ...
         while(_loc1_ <= 2)
         {
            _loc2_ = this.var_55.windowManager.getDesktop(_loc1_);
      ...
      private function showQuestReminder(param1:QuestCampaign, param2:Quest) : void
      {
         ...
         this.var_96 = IWindowContainer(this.var_55.getXmlWindow("QuestReminder"));
         ...
         this.var_133 = new QuestView(param1,param2,true);
         _loc4_.addChild(this.var_133.view);
         this.var_133.init();
      ...
      {
         if(this.var_133 != null && this.var_96 != null && this.var_133.quest != null && this.var_133.quest.status != QuestStatusEnum.const_47)
         {
            this.var_96.visible = false;
         }
      }
      ...
      {
         return param1 == QuestStatusEnum.const_47 || param1 == QuestStatusEnum.const_405;
      }
      ...
      private function onReminderWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            this.var_96.visible = false;
            this.var_1463 = true;
            _loc3_ = this.var_133.quest.campaign.code + "." + this.var_133.quest.localizationCode;
      ...
      private function refreshTabs() : void
      {
         ...
         for each(_loc4_ in this.var_107.getKeys())
         {
            ...
            if(!_loc2_)
            {
               ...
               _loc2_ = this.var_55.windowManager.createWindow("tab_" + _loc4_,"${" + _loc6_ + "}",WindowType.const_600) as ITabButtonWindow;
               if(_loc3_.expired)
               {
