package com.sulake.habbo.quest
{
   ...
   public class IncomingMessages implements IDisposable
   {
      ...
      private var var_1727:IAlertDialog;
         ...
         if(this.var_55.toolbar != null)
         {
            if(param1)
            {
               ...
               if(this.var_55.habboHelp && _loc3_)
               {
                  ...
                  this.var_55.habboHelp.setWelcomeNotifications(_loc5_);
               }
               this._communication.getHabboMainConnection(null).send(new GetExpiredQuestCampaignsMessageComposer());
            }
            else
            {
               this.var_55.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_158,HabboToolbarIconEnum.QUESTS));
            }
         }
      }
