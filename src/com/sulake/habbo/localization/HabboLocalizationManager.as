package com.sulake.habbo.localization
{
   ...
   public class HabboLocalizationManager extends CoreLocalizationManager implements IHabboLocalizationManager
   {
      ...
      {
         this.var_1872 = new Dictionary();
         this.var_2633 = ["I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII","XIII","XIV","XV","XVI","XVII","XVIII","XIX","XX"];
         super(param1,param2,param3);
         this.var_1873 = (param2 & 0) > 0;
         if(!this.var_1873)
         {
            lock();
         }
      ...
      {
         this.var_1872[param1] = param2;
      }
      
      private function getBadgePointLimit(param1:String) : int
      {
         return this.var_1872[param1];
      }
      ...
      {
         return this.var_2633[Math.max(0,param1 - 1)];
      }
   }
}
