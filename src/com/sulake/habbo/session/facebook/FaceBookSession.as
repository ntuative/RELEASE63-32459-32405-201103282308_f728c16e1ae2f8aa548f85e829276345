package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_937:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1273:String = "sendAccessTokenToServer";
      
      private static const const_1272:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1273,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1272,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_937);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_937);
         }
      }
