package com.sulake.habbo.session
{
   ...
   public class UserDataManager implements IUserDataManager
   {
      ...
      private static const const_1789:int = 3;
      ...
      {
         return this.getUserDataByType(param1,const_1345);
      }
      ...
      public function getUserBadges(param1:int) : Array
      {
         ...
         var _loc2_:* = this.var_939.getValue(param1) as Array;
         if(_loc2_ == null)
         {
            _loc2_ = [];
         }
      ...
      {
         this.var_939.remove(param1);
         this.var_939.add(param1,param2);
      }
      
      public function method_10(param1:Array) : void
      {
