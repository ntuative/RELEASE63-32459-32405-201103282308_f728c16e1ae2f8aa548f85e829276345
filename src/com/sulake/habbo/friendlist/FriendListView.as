package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1768:String = "noconvinfo";
      
      private static const const_1769:String = "messageinput";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1341:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1341 = new FriendListTabsView(this._friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_875 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_248 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_1341.prepare(this.var_875);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1126,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1176,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_924,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_707,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_924,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_707,true);
         this.var_16.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1342 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1342.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1628 == -1 ? 0 : int(this.var_16.height - this.var_1628);
         var _loc4_:int = this.var_1626 == -1 ? 0 : int(this.var_16.width - this.var_1626);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_248.y = Util.getLowestPoint(this.var_16.content);
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1257,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_924,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1126,false);
         ...
         this.var_1628 = this.var_16.height;
         this.var_1626 = this.var_16.width;
