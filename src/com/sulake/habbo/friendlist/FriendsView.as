package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_2004:String = "bg";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2801:IContainerButtonWindow;
      
      private var var_2800:IContainerButtonWindow;
      
      private var var_2799:IContainerButtonWindow;
      ...
      {
         this.var_2801 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2800 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2799 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2798 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2801,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2800,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2799,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2798,this.isEnableRemoveButton(_loc1_));
      }
