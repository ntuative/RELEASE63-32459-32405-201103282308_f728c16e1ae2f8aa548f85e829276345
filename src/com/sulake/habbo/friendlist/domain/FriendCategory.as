package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      {
         return Math.ceil(this.var_225.length / const_377);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_937 * const_377;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_937 + 1) * const_377,this.var_225.length);
      }
