package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategories
   {
         ...
         try
         {
            ...
            for each(updatedFriend in p.updatedFriends)
            {
               ...
               if(currentlyOnline && !updatedFriend.online)
               {
                  ...
                  this.var_460.notifications.addOfflineNotification(updatedFriend.name,updatedFriend.realName);
               }
               if(!currentlyOnline && updatedFriend.online)
               {
                  this.var_460.messenger.setOnlineStatus(updatedFriend.id,updatedFriend.online);
                  this.var_460.view.setNewMessageArrived();
                  this.var_460.notifications.addOnlineNotification(updatedFriend.name,updatedFriend.figure,updatedFriend.realName);
               }
      ...
      private function updateCategories(param1:Array) : void
      {
         ...
         this.findCategory(FriendCategory.const_388).received = true;
         this.findCategory(FriendCategory.const_1172).received = true;
