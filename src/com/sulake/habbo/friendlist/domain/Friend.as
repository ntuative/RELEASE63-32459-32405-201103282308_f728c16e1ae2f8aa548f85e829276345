package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1932:int = "F".charCodeAt(0);
      
      public static const const_1946:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_1587 = param1.motto;
         this.var_1590 = param1.lastAccess;
         this.var_1440 = param1.categoryId;
         this.var_1588 = param1.realName;
