package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      public function fillFooter(param1:IWindowContainer) : void
      {
         ...
         this.var_1976 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1976.procedure = this.onDismissAllButtonClick;
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_1080)
         {
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_363 && _loc4_.state != FriendRequest.const_354)
            {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1976,_loc1_);
      }
