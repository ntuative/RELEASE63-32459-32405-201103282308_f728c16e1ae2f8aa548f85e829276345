package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_2714:FriendListLookAndFeel;
      
      private var var_434:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1943:OpenedToWebPopup;
      
      private var var_2350:int;
      
      var var_102:FriendCategories;
      
      private var var_382:FriendRequests;
      
      private var var_1944:AvatarSearchResults;
      ...
      {
         this.var_2714 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_102 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1944 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1127)
         {
            this.var_1127.release(new IIDAvatarRenderManager());
            this.var_1127 = null;
         }
         ...
         if(this.var_812)
         {
            this.var_812.release(new IIDSessionDataManager());
            this.var_812 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1943 = new OpenedToWebPopup(this);
         }
         this.var_1943.show(x,y);
      }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(this.var_382.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_316,HabboWindowStyle.const_43,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1127.createAvatarImage(param1,AvatarScaleType.const_90,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_382 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_102.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_102.addCategory(new FriendCategory(FriendCategory.const_1172,this.getText("friendlist.friends")));
         this.var_102.addCategory(new FriendCategory(FriendCategory.const_388,this.getText("friendlist.friends.offlinecaption")));
         ...
         this.var_180.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_151,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_102.findCategory(FriendCategory.const_388);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_382.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_382.addRequest(new FriendRequest(_loc3_));
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_382.addRequestAndUpdateView(_loc3_);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1944.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         if(!this.var_812 || !this.var_382)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_812.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_45))
         {
            _loc2_ = this.var_382.vipLimit;
         }
         else if(this.var_812.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_44))
         {
            _loc2_ = this.var_382.clubLimit;
         }
         if(_loc2_ > this.var_382.limit)
         {
            this.var_382.limit = _loc2_;
         }
      }
