package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1023:uint = 11;
      ...
      private var var_1279:IHabboWindowManager;
      ...
      private var var_678:FramerateTracker = null;
      
      private var var_275:LatencyTracker = null;
      
      private var var_679:LagWarningLogger = null;
      
      private var var_680:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_678 = new FramerateTracker();
         this.var_275 = new LatencyTracker();
         this.var_679 = new LagWarningLogger();
         this.var_680 = new ToolbarClickTracker(this);
         this.var_1540 = new Array(const_1023);
         var _loc4_:int = 0;
         while(_loc4_ < const_1023)
         {
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1637,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1526,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1559,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_912,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1030,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1279)
            {
               this.var_1279.release(new IIDHabboWindowManager());
               this.var_1279 = null;
            }
            if(this.var_314)
            {
            ...
            if(this.var_211)
            {
               if(!this.var_211.disposed)
               {
                  ...
                  Component(this.var_211).events.removeEventListener(HabboFriendListTrackingEvent.const_395,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_180)
            {
               ...
               {
                  this.var_180.events.removeEventListener(HabboToolbarEvent.const_37,this.onToolbarClick);
               }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_192)
         {
            if(this.var_275 != null)
            {
               this.var_275.configuration = this.var_192;
            }
            if(this.var_276 != null)
            {
               this.var_276.configuration = this.var_192;
            }
            ...
            if(this.var_192)
            {
               ...
               {
                  this.var_679.configure(this.var_192);
               }
               if(this.var_678 != null)
               {
                  this.var_678.configure(this.var_192);
               }
               if(this.var_680 != null)
               {
                  this.var_680.configure(this.var_192);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_643,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_702,this.onHotelViewEvent);
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_702)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1629);
         }
         else if(param1.type == HabboHotelViewEvent.const_521)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1515);
         }
         else if(param1.type == HabboHotelViewEvent.const_71)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1715);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1453);
               break;
            case HabboCommunicationEvent.const_643:
               this.trackLoginStep(HabboLoginTrackingStep.const_1574,String(this._communication.port));
               break;
      ...
      {
         this.var_1279 = IHabboWindowManager(param2);
         if(this.var_1279)
         {
      ...
      private function onCoreRunning(param1:Event) : void
      {
         ...
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1267,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_211).events.addEventListener(HabboFriendListTrackingEvent.const_395,this.onFriendlistTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1030,String(_loc2_.guestRoomId));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_228,this.onRoomAdClick);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_314 = param2 as IAdManager;
         this.var_314.events.addEventListener(AdEvent.const_481,this.onRoomAdLoad);
      }
      
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_180 = param2 as IHabboToolbar;
         this.var_180.events.addEventListener(HabboToolbarEvent.const_37,this.onToolbarClick);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_680)
         {
            this.var_680.track(param1.iconName);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_2015;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_2015);
         }
         if(this.var_548 > -1 && _loc2_ - this.var_548 > 15000)
         {
            ++this.var_2016;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_2016);
         }
         this.var_548 = _loc2_;
         if(this.var_276 != null)
         {
            this.var_276.update(param1,this.var_548);
         }
         if(this.var_275 != null)
         {
            this.var_275.update(param1,this.var_548);
         }
         if(this.var_678 != null)
         {
            this.var_678.trackUpdate(param1,this,this.var_548);
         }
         if(this.var_679 != null)
         {
            this.var_679.update(this.var_548);
         }
      }
   }
}
