package com.sulake.habbo.tracking
{
   ...
   public class LagWarningLogger
   {
      ...
      {
         this.var_1991 = Boolean(int(param1.getKey("lagWarningLog.enabled","1")));
         this.var_1624 = int(param1.getKey("lagWarningLog.interval.seconds","10")) * 1000;
      }
      
      public function chatLagDetected(param1:int) : void
      {
         if(!this.var_1991 || this.var_1624 <= 0)
         {
            return;
         }
         ++this.var_1079;
      ...
      private function reportWarningsAsNeeded(param1:int) : void
      {
         ...
         if(this._lastWarning == 0 || param1 - this._lastWarning > this.var_1624)
         {
