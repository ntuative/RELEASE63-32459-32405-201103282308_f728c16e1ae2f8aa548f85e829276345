package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_1248:Number = 1;
      
      private var var_1509:Number = 0;
      
      private var var_1961:Number = 15;
      
      private var var_1960:Number = 5;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IConnection, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_231 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_73,HabboWindowStyle.const_1220,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1249 = String(_loc8_.relocate_by_drag.@state) == "true";
         if(this.var_1249)
         {
         ...
         this.var_1248 = _loc8_.toolbar.@margin_top;
         this.var_1509 = _loc8_.toolbar.@margin_bottom;
         this.var_1961 = _loc8_.toolbar.@min_group_margin;
         this.var_1960 = _loc8_.toolbar.@margin_to_extrabar;
         ...
         this.createGroupsFromXmlList(_loc9_,this.var_267,param1,param2,param3,this._window,this.var_300);
         this.createGroupsFromXmlList(_loc10_,this.var_666,param1,param2,param3,this.var_231,this.var_300);
         this.alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_172,this.var_536,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_536);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_172,this.var_536);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_172,this.var_536);
         }
      }
      ...
      {
         this.alignWindows();
         var _loc2_:HabboToolbarEvent = new HabboToolbarEvent(HabboToolbarEvent.const_807);
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < this.var_666.length)
         {
            _loc2_ = this.var_666[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      private function alignWindows() : void
      {
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_231.x = this.var_172 + this.var_1960;
               this.var_231.y = 0;
            ...
            case "TOP":
               ...
               this._window.y = 0;
               this.var_231.x = 0;
               this.var_231.y = this.var_172 + this.var_1960;
         ...
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1248;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_267.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this.var_1961,(this._window.height - _loc5_ * _loc8_ - this.var_1248 - this.var_1509) / (this.var_267.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1961,(this._window.width - _loc5_ * _loc8_ - this.var_1248 - this.var_1509) / (this.var_267.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_267.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_536;
      ...
      private function onStageMouseMove(param1:MouseEvent) : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_1249 && this.var_1508)
         {
            _loc2_ = this.getTargetOrientationFromXY(param1.stageX,param1.stageY);
            if(_loc2_ != null && _loc2_ != this.var_536)
            {
               this.var_536 = _loc2_;
               this.alignWindows();
               if(this._events != null)
               {
                  _loc3_ = new HabboToolbarEvent(HabboToolbarEvent.const_598);
                  _loc3_.orientation = this.var_536;
