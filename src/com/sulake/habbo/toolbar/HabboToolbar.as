package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_296.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
      }
      ...
      {
         this._view = new ToolbarView(this._windowManager,this._assetLibrary,this.var_296.getHabboMainConnection(null),events,this._config);
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_151,this.onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_1102,this.onSetToolbarIconBitmapEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_587,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1180,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1166,this.onHideWindowEvent);
         this._state = true;
