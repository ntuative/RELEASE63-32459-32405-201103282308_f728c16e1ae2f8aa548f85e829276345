package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      {
         return this.var_1461.indexOf(param1) > -1;
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = this.var_2606.elements("menu");
         var _loc5_:int = 0;
      ...
      {
         var _loc3_:* = null;
         var _loc2_:int = this.var_779.indexOf(param1);
         if(_loc2_ > -1)
         {
            _loc3_ = this.getIconById(param1);
            if(_loc3_ != null)
      ...
      public function get size() : Number
      {
         ...
         {
            if(this.var_304[_loc2_].exists)
            {
               _loc1_ += this.var_1462;
            }
            _loc2_++;
         }
         return _loc1_;
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_1460.length)
         {
            _loc2_ = this.var_779.indexOf(this.var_1460[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = this.var_304[_loc2_];
               if(_loc1_.exists)
               {
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return this.var_304[this.var_779.indexOf(param1)];
      }
      ...
      public function getIconByMenuId(param1:String) : ToolbarIcon
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         while(_loc3_ < this.var_304.length)
         {
            _loc2_ = this.var_304[_loc3_];
            if(_loc2_ != null)
            {
