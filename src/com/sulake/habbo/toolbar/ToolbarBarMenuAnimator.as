package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1391:Number = 25;
      
      private static const const_1392:Number = 90;
      
      private static const const_1015:int = 50;
      
      private static const const_1423:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1506:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_811 = new Timer(const_1391);
         this.var_811.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      {
         return param1.x + param1.width < const_1015 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_1015 || param1.desktop.height - param1.y < const_1423;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1506.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = this.var_1506.getIconLoc(param1.iconId);
      ...
      {
         return this.var_660[this.var_661.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_661[this.var_660.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_661.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_661.splice(_loc3_,1);
            this.var_660.splice(_loc3_,1);
         }
         this.var_660.push(param1.name);
         this.var_661.push(param2);
         param1.addEventListener(WindowEvent.const_378,this.windowEventListener);
         param1.addEventListener(WindowEvent.const_237,this.windowEventListener);
      }
