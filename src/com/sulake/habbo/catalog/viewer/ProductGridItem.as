package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_974:String = "bg";
      ...
      {
         this._view.getChildByName(const_974).style = HabboWindowStyle.const_32;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_974).style = 3;
      }
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_25 && this.var_622 != null && this.var_622 == param2)
         {
