package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1757:String = "ctlg_";
      ...
      private var var_1195:ItemGridCatalogWidget;
      ...
      {
         return this._localization.getLinks(this.var_1194);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1194);
      }
      ...
      {
         var _loc2_:String = const_1757 + param1;
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1633:
               if(this.var_1195 == null)
               {
                  this.var_1195 = new ItemGridCatalogWidget(param1);
                  this.var_47.push(this.var_1195);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1696:
               ...
               break;
            case CatalogWidgetEnum.const_1535:
