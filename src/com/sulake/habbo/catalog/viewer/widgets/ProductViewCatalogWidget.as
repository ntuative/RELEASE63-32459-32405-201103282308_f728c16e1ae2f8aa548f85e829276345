package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1640 = new Point(this.var_84.x,this.var_84.y);
         this.var_481 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1345 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1639 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_1090.y = this.var_885.y + this.var_885.height;
         ...
         else
         {
            ...
            {
               case Offer.const_564:
                  _loc6_ = this.var_1639.clone();
                  if(this.var_481 != null)
                  {
                     this.var_481.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_481,this.var_1345,this.var_2030);
                     this.var_481.scrollV = 0;
                  }
                  break;
               case Offer.const_538:
                     ...
                     case ProductTypeEnum.const_183:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_288,AvatarAction.const_554);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2210)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_84 != null && true)
         {
            ...
            this.var_84.x = this.var_1640.x;
            this.var_84.y = this.var_1640.y;
            if(param3 != null)
            {
