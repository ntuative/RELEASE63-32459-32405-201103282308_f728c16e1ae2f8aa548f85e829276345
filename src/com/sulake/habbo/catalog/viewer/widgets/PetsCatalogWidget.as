package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IPetDataListener, IPetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         events.addEventListener(WidgetEvent.const_637,this.onApproveNameResult);
      ...
      private function onWidgetsInitialized(param1:CatalogWidgetsInitializedEvent = null) : void
      {
         ...
         var _loc3_:* = [];
         for each(_loc4_ in this.var_341)
         {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         this.var_480 = param1.index;
         if(this.var_480 < 0 || this.var_480 > this.var_341.length)
         {
            this.var_480 = 0;
         }
         this.updateImage();
      ...
      private function updateImage() : void
      {
         ...
         if(this.var_198 == null || this.var_707 >= this.var_198.length)
         {
            return;
         }
         var _loc2_:* = 0;
         if(this.var_480 >= 0 && this.var_480 < this.var_341.length)
         {
            _loc7_ = this.var_341[this.var_480] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:int = this.var_198[this.var_707] as int;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImage(this.var_540,_loc3_,_loc2_,AvatarScaleType.const_57,this);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_288,AvatarAction.const_908);
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(this.var_480 >= this.var_341.length)
         {
            return "";
         }
         var petColor:IPetColor = this.var_341[this.var_480] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:int = this.var_198[this.var_707] as int;
