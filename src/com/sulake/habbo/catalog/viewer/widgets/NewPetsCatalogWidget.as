package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1425:int = 18;
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_198 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1425 && _loc2_ < this.var_198.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_540,this.var_198[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_540,this.var_386),this.getRaceLocalizationKey(this.var_540,this.var_386));
            }
         }
         return this.getRaceLocalizationKey(this.var_540,this.var_386);
      }
