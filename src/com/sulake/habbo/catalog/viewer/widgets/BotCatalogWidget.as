package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class BotCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IAvatarImageListener
   {
      ...
      private var var_376:IGridItem;
      
      public function BotCatalogWidget(param1:IWindowContainer)
      {
         super(param1);
         this.var_1045 = _window.findChildByName("botGrid") as IItemGridWindow;
      ...
      {
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_694,page.pageId);
      }
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         if(_loc5_)
         {
            ...
            _loc4_.invalidate();
            this.var_1576.add(_loc3_,param1.offerId);
            _loc5_.dispose();
         }
      }
      ...
      {
         var _loc1_:String = this.var_1314.getValue(this.var_694.productContainer.firstProduct.extraParam.toLowerCase());
      ...
      private function setProductData() : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc1_.registerParameter(_loc5_,"credits",String(this.var_694.priceInCredits));
            _loc1_.registerParameter(_loc5_,"pixels",String(this.var_694.priceInActivityPoints));
            _loc2_.text = _loc1_.getKey(_loc5_);
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(this.var_694.localizationId);
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         var _loc2_:int = this.var_1576.getValue(param1);
         if(true)
         {
            return;
         }
         for each(_loc3_ in page.offers)
         {
            if(_loc3_.offerId == _loc2_ && _loc3_.productContainer && _loc3_.productContainer.view && !_loc3_.productContainer.view.disposed)
            {
               ...
               if(_loc7_)
               {
                  ...
                  _loc6_.invalidate();
                  _loc7_.dispose();
                  if(this.var_694.offerId == _loc2_)
                  {
                     this.updatePreviewImage();
                  }
               }
