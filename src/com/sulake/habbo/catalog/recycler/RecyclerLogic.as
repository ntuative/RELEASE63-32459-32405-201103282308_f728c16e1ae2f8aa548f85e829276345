package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_599 != const_951;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1702 != RecyclerStatusMessageEvent.const_1264;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_599 == const_425;
      }
      ...
      {
         this.var_599 = const_952;
         this.var_116 = new Array(const_204);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_1609:
               this.var_599 = const_425;
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_116.length < const_204)
         {
            return false;
         }
         var _loc1_:int = 0;
