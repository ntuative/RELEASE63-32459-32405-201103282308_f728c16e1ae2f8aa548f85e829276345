   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1672 = _loc1_.stuffTypes;
            this.var_829 = _loc1_.boxTypes;
            this.var_828 = _loc1_.ribbonTypes;
            this.var_1275 = this.var_1672[0];
            this.var_390 = this.var_829[0];
            this.var_389 = this.var_828[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_389 < 0)
         {
            this.var_389 = this.var_828.length - 1;
         }
         if(this.var_389 > this.var_828.length - 1)
         {
            this.var_389 = 0;
         }
         if(this.var_390 < 0)
         {
            this.var_390 = this.var_829.length - 1;
         }
         if(this.var_390 > this.var_829.length - 1)
         {
            this.var_390 = 0;
         }
         var _loc1_:int = this.var_829[this.var_390] * 1000 + this.var_828[this.var_389];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_92.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1275,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1535 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1672;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1275);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_829[this.var_390]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_828[this.var_389]);
         this._catalog.purchaseProductAsGift(this.var_1533,this.var_92,this.var_1534,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this.var_1533,this.var_92.offerId,this.var_1534);
               this.dispose();
               break;
            case "cancel_button":
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_41:
               ...
               break;
            case WindowKeyboardEvent.const_373:
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_672 == null)
         {
            this.var_672 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_672.procedure = this.suggestionsEventHandler;
         }
         if(this.var_271 == null || this.var_672 == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_672.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1275;
               }
            }
            _loc4_++;
         }
