package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static var var_1415:XML;
       
      
      private var var_1765:Number = 4.294967295E9;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1415 == null)
         {
            ...
            var_1415 = _loc4_.content as XML;
         }
      }
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1765 == 4294967295)
            {
               this.var_1765 = _loc1_.color;
            }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1596;
            }
         }
      }
      ...
      {
         this.var_60 = navigator.catalog.windowManager.buildFromXML(var_1415) as IItemListWindow;
         if(this.var_60 == null)
         {
