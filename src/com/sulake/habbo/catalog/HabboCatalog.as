package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_2755:GiftWrappingConfiguration;
      
      private var var_1266:ClubGiftController;
      ...
      private var var_1018:IPurchasableOffer;
      
      private var var_1267:IDragAndDropDoneReceiver;
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_108.getActivityPointsForType(Purse.const_209)));
         var _loc1_:int = 0;
      ...
      {
         this.var_180.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_151,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_81:
               this.var_1986 = param1.session.isPrivateRoom;
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1266 = new ClubGiftController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_387.openPage(this.var_823);
            this.var_823 = "";
            this.var_1019 = -1;
         }
         else if(this.var_1019 > -1)
         {
            this.var_387.openPageById(this.var_1019,this.var_1987);
            this.var_1019 = -1;
            this.var_1987 = -1;
            this.var_823 = "";
         }
      ...
      private function onApproveNameResult(param1:ApproveNameMessageEvent) : void
      {
         ...
         this.var_319.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result,_loc2_.nameValidationInfo));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2753 && this.var_489 != null)
         {
            this.var_489.playSound(HabboSoundTypesEnum.const_1092);
         }
         this.var_2753 = false;
         if(this.var_318 != null)
         {
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_66,this.var_108.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2754 && this.var_489 != null)
         {
            this.var_489.playSound(HabboSoundTypesEnum.const_1032);
         }
         this.var_2754 = false;
         if(this.var_318 != null)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1266.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2755 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            this.var_319.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      public function requestSelectedItemToMover(param1:IDragAndDropDoneReceiver, param2:Offer) : void
      {
         ...
         if(!this.var_1093 || !this.var_1093.isRoomOwner)
         {
            return;
         }
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_1268 && param1.type == RoomEngineObjectEvent.const_171)
         {
            this.resetPlacedOfferData();
            if(this.var_1018 == null || !param1.placedInRoom)
            {
               this.resetObjectMover();
               return;
            }
            this.var_88 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_1018);
            if(this.var_1267 != null)
            {
               this.var_1267.onDragAndDropDone(true);
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_1018.productContainer.firstProduct;
            ...
            if(_loc4_)
            {
               _loc4_.getModelController().setNumber(RoomObjectVariableEnum.const_336,0.5);
            }
            this.resetObjectMover();
         }
      }
