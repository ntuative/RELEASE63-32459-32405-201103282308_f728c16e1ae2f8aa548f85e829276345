package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2072:String = "my_issues";
      
      private const const_2071:String = "open_issues";
      
      private const const_2073:String = "picked_issues";
      
      private const const_2093:String = "closed_issues";
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_256 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_256.numTabItems)
            {
               _loc5_ = this.var_256.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_63,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_256 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_256 == null || this.var_256.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_256.selector.getSelectableByName("open_issues");
         this.var_256.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_362.view.width = this.var_256.container.width;
         this.var_362.view.height = this.var_256.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2072:
               ...
               {
                  this.var_1788 = new MyIssuesView(this.issueManager,this,this.var_256.container);
               }
               return this.var_1788;
            case this.const_2071:
               if(this.var_1787 == null)
               {
                  this.var_1787 = new OpenIssuesView(this.issueManager,this,this.var_256.container);
               }
               return this.var_1787;
            case this.const_2073:
               if(this.var_1789 == null)
               {
                  this.var_1789 = new PickedIssuesView(this.issueManager,this,this.var_256.container);
               }
