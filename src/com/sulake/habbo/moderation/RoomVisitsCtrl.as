package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_861:Array = [];
      
      private static var var_1585:int = 200;
      ...
      {
         this.var_697 = IWindowContainer(this.var_33.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1703;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_861.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_697.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_861.length < var_1585)
         {
            ...
            param1.width = this.var_697.width;
            param1.height = this.var_697.height;
            var_861.push(param1);
         }
         else
         {
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1322)
         {
