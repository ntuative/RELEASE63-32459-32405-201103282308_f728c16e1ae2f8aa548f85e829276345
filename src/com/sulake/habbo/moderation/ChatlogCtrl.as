package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_942:Array = [];
      
      private static var var_1799:int = 1000;
      
      private static var var_943:Array = [];
      ...
      {
         this.var_762 = IWindowContainer(this.var_33.getXmlWindow("chatlog_roomheader"));
         this.var_761 = IWindowContainer(this.var_33.getXmlWindow("chatlog_chatline"));
         ...
         this.var_33.connection.send(this.var_1797);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_942.pop() as IWindowContainer;
         }
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_943.pop() as IWindowContainer;
         }
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1430.getValue(param2.chatterName))
            {
               this.var_1430.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1430.getValue(_loc2_);
