package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1190:String = "issue_bundle_open";
      
      public static const const_840:String = "issue_bundle_my";
      
      public static const const_1211:String = "issue_bundle_picked";
      
      public static const const_1618:int = 15000;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_1594 = new Timer(const_1618,0);
         this.var_1594.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_1594.start();
      }
      ...
      public function pickBundle(param1:int, param2:Boolean = false, param3:int = 0) : void
      {
         ...
         this.var_1068 = this.var_1068.concat(_loc4_.getIssueIds());
      }
      ...
      public function releaseAll() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_372 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         this.var_1069 = this.var_1069.concat(param1);
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         {
            this.var_66.soundManager.playSound(HabboSoundTypesEnum.const_1240);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(this.var_866.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_104.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
            {
               if(this.method_4(_loc3_,param1))
               {
               ...
               else
               {
                  ...
                  this.var_866.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1531)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            ...
            {
               if(this.method_4(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  this.var_866.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            _loc2_ = this.var_2146++;
            _loc3_ = new IssueBundle(_loc2_,param1);
            this.var_866.add(param1.issueId,_loc2_);
         ...
         {
            _loc6_ = this.getBundles(const_840);
            _loc7_ = false;
            for each(_loc8_ in _loc6_)
            {
               if(this.method_4(_loc8_,param1,true))
               {
                  _loc7_ = true;
                  break;
               }
            }
            _loc9_ = this.var_1069.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      {
         var _loc2_:IssueHandler = this.var_867.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_867.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = this.var_866.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_104.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
         ...
         for each(_loc4_ in this.var_104)
         {
            switch(param1)
            {
               case const_1190:
                  ...
                  break;
               case const_840:
                  if(_loc4_.state == IssueMessageData.const_372 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         this.var_867.add(param1,_loc3_);
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_867.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      private function method_4(param1:IssueBundle, param2:IssueMessageData, param3:Boolean = false) : Boolean
      {
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_372 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.prioritySum > _loc3_.prioritySum))
            {
               _loc3_ = _loc5_;
            }
         }
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_867.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
