package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_962:int = 3600;
      
      private static const const_963:int = 86400;
      
      private static const const_965:int = 31536000;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         if(param1 < 2 * const_962)
         {
            return Math.round(param1 / const_964) + " mins ago";
         }
         if(param1 < 2 * const_963)
         {
            return Math.round(param1 / const_962) + " hours ago";
         }
         if(param1 < 2 * const_965)
         {
            return Math.round(param1 / const_963) + " days ago";
         }
         return Math.round(param1 / const_965) + " years ago";
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_33,WindowTracker.const_1189,this._data.userId),this._callerFrame,this.var_1152,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new RoomVisitsCtrl(this.var_33,this._data.userId),this._callerFrame,this.var_1152,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new SendMsgsCtrl(this.var_33,this._data.userId,this._data.userName,this.var_1510),this._callerFrame,this.var_1152,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new ModActionCtrl(this.var_33,this._data.userId,this._data.userName,this.var_1510),this._callerFrame,this.var_1152,false,true);
      }
