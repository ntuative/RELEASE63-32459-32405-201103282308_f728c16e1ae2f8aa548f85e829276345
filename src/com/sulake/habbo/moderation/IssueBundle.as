package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2550 = param2.pickerUserId;
         this.var_2621 = param2.pickerUserName;
         this.var_1517 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1191 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1190;
         }
         if(this.var_781 == null || param1.timeStamp < this.var_781.timeStamp)
         {
            this.var_781 = param1;
         }
         if(this.var_780 == null || param1.priority > this.var_780.timeStamp)
         {
            this.var_780 = param1;
         }
      }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_780;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_781;
         if(_loc2_ == null)
         {
