package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_1159:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         this.var_504 = new UserInfoCtrl(this._window,this.var_66,_loc3_.message);
         this.var_1159 = new UserInfoCtrl(this._window,this.var_66,_loc3_.message);
         ...
         {
            this.var_1159.load(_loc4_,this.var_162.reportedUserId);
         }
         else
         {
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_66.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_66,WindowTracker.const_1138,_loc2_),this._window,false,false,true);
      }
