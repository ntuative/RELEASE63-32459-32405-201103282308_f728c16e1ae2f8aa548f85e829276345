package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_236 = param2;
         this.var_740 = [];
         this.var_740.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_740.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         ...
         this.var_80.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_671,this.onSoundMachinePlayEvent);
         this.var_80.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_805,this.onSoundMachineStopEvent);
      }
      ...
      {
         return HabboMusicPrioritiesEnum.const_412;
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_80)
            {
               this.var_80.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_671,this.onSoundMachinePlayEvent);
               this.var_80.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_805,this.onSoundMachineStopEvent);
               this.var_80 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         {
            this.playCurrentSongAndNotify(this.var_471);
      ...
      {
         this.var_236.stop(HabboMusicPrioritiesEnum.const_412);
         this.var_471 = -1;
         this.var_566 = false;
      }
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_236.playSong(param1,HabboMusicPrioritiesEnum.const_412,_loc3_))
         {
      ...
      private function convertParserPlayList(param1:Array) : Array
      {
         ...
         {
            if(this.var_236.getSongInfo(_loc3_.id) == null)
            {
               _loc2_.push(new SongDataEntry(_loc3_.id,_loc3_.length,_loc3_.name,_loc3_.creator,null));
            }
            else
            {
               _loc2_.push(this.var_236.getSongInfo(_loc3_.id) as SongDataEntry);
            }
         }
         return _loc2_;
      }
      ...
      private function onPlayListMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc8_ < _loc5_.length)
         {
            ...
            {
               this.var_471 = _loc6_.id;
               _loc6_.startPlayHeadPos = Number(_loc4_) / 1000;
            }
            _loc4_ -= _loc6_.length;
            _loc8_++;
         }
         this._events.dispatchEvent(new PlayListUpdatedEvent(PlayListUpdatedEvent.const_574));
         if(_loc6_ != null && this.var_566)
         {
