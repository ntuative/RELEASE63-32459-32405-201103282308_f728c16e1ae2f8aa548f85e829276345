package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private var var_489:HabboSoundManagerFlash10;
      ...
      private var var_443:IPlayListController = null;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_80.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_784,this.onJukeboxInit);
         this.var_80.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_862,this.onJukeboxDispose);
         this.var_80.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_901,this.onSoundMachineInit);
         this.var_80.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_894,this.onSoundMachineDispose);
         this.var_1227 = new Timer(1000);
         this.var_1227.start();
         this.var_1227.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
         ...
         {
            this.var_1228[_loc5_] = -1;
            this.var_651[_loc5_] = null;
            _loc5_++;
         }
      }
      ...
      {
         if(this.getSongIdPlayingAtPriority(this.var_444) == param1.id)
         {
            this.resetSongIdPlayingAtPriority(this.var_444);
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_652)
            {
               ...
               {
                  _loc2_ = this.var_652.getWithIndex(_loc1_) as SongDataEntry;
            ...
            if(this.var_80)
            {
               this.var_80.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_784,this.onJukeboxInit);
               this.var_80.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_862,this.onJukeboxDispose);
               this.var_80.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_901,this.onSoundMachineInit);
               this.var_80.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_894,this.onSoundMachineDispose);
            }
            this._disposed = true;
         }
      }
      ...
      private function processSongEntryForPlaying(param1:int, param2:Boolean = true) : Boolean
      {
         ...
         {
            _loc3_.soundObject = this.var_489.loadTraxSong(_loc3_.id,_loc3_.songData);
         }
      ...
      {
         var _loc2_:* = param1 == this.var_444;
      ...
      private function stopSongAtPriority(param1:int) : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(param1 == this.var_444 && this.var_444 >= 0)
         {
      ...
      {
         return this.var_652.getValue(param1) as SongDataEntry;
      }
      ...
      private function requestSong(param1:int, param2:Boolean) : void
      {
         ...
         {
            this.var_650.add(param1,param2);
      ...
      private function getSongIdRequestedAtPriority(param1:int) : int
      {
         ...
         if(this.var_651[param1] == null)
         {
            return -1;
         }
         var _loc2_:SongStartRequestData = this.var_651[param1];
      ...
      private function playSongObject(param1:int, param2:int) : Boolean
      {
         ...
         this.stopSongAtPriority(this.var_444);
         ...
         _loc4_.volume = this.var_489.volume;
         var _loc5_:* = Number(const_1039);
         var _loc6_:* = 0;
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2684 != param1.id || _loc3_ > this.var_2685 + 8000))
         {
            this.var_489.notifyPlayedSong(param1.name,param1.creator);
            this.var_2684 = param1.id;
            this.var_2685 = _loc3_;
         }
      }
      
      private function getTopRequestPriority() : int
      {
         var _loc1_:int = this.var_651.length - 1;
         while(_loc1_ >= 0)
         {
            if(this.var_651[_loc1_] != null)
            {
               return _loc1_;
            }
            _loc1_--;
      ...
      private function areSamplesRequested(param1:int) : Boolean
      {
         ...
         return this.var_650.getValue(param1);
      }
      ...
      private function onSongDiskInventoryMessage(param1:IMessageEvent) : void
      {
         ...
         this.var_1690 = _loc3_.songDiskInventory;
         this._events.dispatchEvent(new SongDiskInventoryReceivedEvent(SongDiskInventoryReceivedEvent.const_1598));
      }
      
      private function onSoundMachineInit(param1:Event) : void
      {
         this.var_443 = new SoundMachinePlayListController(this.var_489,this,this._events,this.var_80,this._connection) as IPlayListController;
      }
      ...
      {
         this.var_443 = new JukeboxPlayListController(this.var_489,this,this._events,this.var_80,this._connection) as IPlayListController;
      }
